...
public final class Compiler {
   ...
   */
  private boolean writeAndroidManifest(File manifestFile, Set<String> permissionsNeeded, Set<String> broadcastReceiversNeeded) {
  ...
  public static boolean compile(Project project, Set<String> componentTypes,
    ...
    if (!compiler.writeAndroidManifest(manifestFile, permissionsNeeded, broadcastReceiversNeeded)) {
      return false;
    }
    setProgress(20);
