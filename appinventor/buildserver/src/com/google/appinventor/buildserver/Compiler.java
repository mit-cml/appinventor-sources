  ...
  private boolean writeAndroidManifest(File manifestFile, Set<String> permissionsNeeded) {
    ...
    try {
      ...
      if (componentTypes.contains("FtcRobotController")) {
        ...
        out.write("    </activity>\n");
        out.write("    <activity\n");
        out.write("      android:name=\".configuration.EditPWMDevicesActivity\"\n");
        out.write("      android:configChanges=\"orientation|screenSize\"\n");
        out.write("      android:label=\"@string/edit_pwm_devices_activity\"\n");
        out.write("      android:windowSoftInputMode=\"stateHidden\" >\n");
        out.write("    </activity>\n");
        out.write("    <activity\n");
        out.write("      android:name=\".configuration.EditAnalogInputDevicesActivity\"\n");
        out.write("      android:configChanges=\"orientation|screenSize\"\n");
        out.write("      android:label=\"@string/edit_analog_input_devices_activity\"\n");
        out.write("      android:windowSoftInputMode=\"stateHidden\" >\n");
        out.write("    </activity>\n");
        out.write("    <activity\n");
        out.write("      android:name=\".configuration.EditDigitalDevicesActivity\"\n");
        out.write("      android:configChanges=\"orientation|screenSize\"\n");
