...
public final class Compiler {
  ...
  private boolean writeAndroidManifest(File manifestFile, Set<String> permissionsNeeded) {
    ...
    String vName = (project.getVName() == null) ? DEFAULT_VERSION_NAME : cleanVame(project.getVName());
    String aName = (project.getAName() == null) ? DEFAULT_APP_NAME : cleanVame(project.getAName());
