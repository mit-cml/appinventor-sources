...
Blockly.Msg.sv.switch_language_to_swedish = {
  ...
  init: function() {
    ...
    Blockly.ERROR_SELECT_VALID_ITEM_FROM_DROPDOWN = "Välj ett giltigt element i rullistan."
    ...
    Blockly.ERROR_DUPLICATE_EVENT_HANDLER = "Händelsehanteraren är en dubblett för den här komponenten."
