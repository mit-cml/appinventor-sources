...
// Context menus.
    ...
    Blockly.Msg.BACKPACK_DOCUMENTATION = "The Backpack is a copy/paste feature. It allows you to copy blocks from one" +
   " project or screen and paste them into another project or screen. " +
   " To copy, drag and drop blocks into the Backpack. To paste, click on the Backpack and " +
   " drag and drop blocks into the workspace." +
   "</p><p>The contents of the Backpack will persist throughout" +
   " an App Inventor session. When you quit App Inventor or refresh its browser window, " +
...
// Control Blocks
    ...
    Blockly.Msg.LANG_CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = 'While a value is true, do some statements.';
    Blockly.Msg.LANG_CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = 'While a value is false, do some statements.';
    ...
    Blockly.Msg.LANG_CONTROLS_FOR_TOOLTIP = 'Counts from a start number to an end number.\n' +
    ...
    Blockly.Msg.LANG_CONTROLS_FORRANGE_TOOLTIP = 'Runs the blocks in the \'do\' section for each numeric\n'
        + 'value in the range from start to end, increasing the value each time.\n'
        + 'Use the given variable name to refer to the current value.';
    ...
    Blockly.Msg.LANG_CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = 'Breaks out of the containing loop.';
    Blockly.Msg.LANG_CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = 'Skips the rest of this loop, and\n' +
    ...
    Blockly.Msg.LANG_CONTROLS_CHOOSE_TOOLTIP = 'If the condition being tested is true,\n'
        + 'returns the result of evaluating the expression attached to the \'then-return\' slot;\n'
        + 'otherwise returns the result of evaluating the expression attached to the \'else-return\' slot;\n'
    ...
    Blockly.Msg.LANG_CONTROLS_DO_THEN_RETURN_TOOLTIP = 'Runs the blocks in \'do\' and returns a statement.\n'
    + 'Useful if you need to run a procedure before returning a value to a variable.';
    ...
    Blockly.Msg.LANG_CONTROLS_EVAL_BUT_IGNORE_TOOLTIP = 'Runs the connected block of code and ignores the return'
        + 'value (if any). Useful if you need to call a procedure with a return value but don\'t need the value.';
    ...
    Blockly.Msg.LANG_CONTROLS_OPEN_ANOTHER_SCREEN_WITH_START_VALUE_TOOLTIP = 'Opens another screen in a' +
    ' multiple-screen app and passes the start value to that screen.';
    ...
    Blockly.Msg.LANG_CONTROLS_GET_START_VALUE_TOOLTIP = 'Returns the value that was passed to this screen when it' +
        ...
        ' passed, returns an empty text value.';
    ...
    Blockly.Msg.LANG_CONTROLS_CLOSE_SCREEN_TOOLTIP = 'Closes the current screen';
    ...
    Blockly.Msg.LANG_CONTROLS_GET_PLAIN_START_TEXT_TOOLTIP = 'Returns the plain text that was passed to this screen when '
        + 'it was started by another app. If no value was passed, returns an empty text value. For '
    ...
    Blockly.Msg.LANG_CONTROLS_CLOSE_SCREEN_WITH_PLAIN_TEXT_TOOLTIP = 'Closes the current screen and returns the\n'
        + 'plain text to the app that opened this one. This command is for returning text to non-App Inventor\n'
        + 'activities, not to App Inventor screens. For App Inventor screens, as in multiple-screen apps, use\n'
        + '\'close screen with value\', not \'close screen with plain text\'.';
...
// Logic Blocks.
    ...
    Blockly.Msg.LANG_LOGIC_COMPARE_TOOLTIP_EQ = 'Tests whether two things are equal. \n' +
        'The things being compared can be any type, not just numbers. \n' +
        ...
        '\"1\" is equal to \"01\".';
    Blockly.Msg.LANG_LOGIC_COMPARE_TOOLTIP_NEQ = 'Returns true if both inputs are not equal to each other.';
    Blockly.Msg.LANG_LOGIC_COMPARE_TRANSLATED_NAME = 'logical equality';
    ...
    Blockly.Msg.LANG_LOGIC_OPERATION_TOOLTIP_AND = 'Returns true if all inputs are true.';
    Blockly.Msg.LANG_LOGIC_OPERATION_TOOLTIP_OR = 'Returns true if any input is true.';
...
// Math Blocks.
    ...
    Blockly.Msg.LANG_MATH_NUMBER_TOOLTIP = 'Reports the number shown.';
    ...
    Blockly.Msg.LANG_MATH_COMPARE_TOOLTIP_EQ = 'Returns true if both numbers are equal to each other.';
    Blockly.Msg.LANG_MATH_COMPARE_TOOLTIP_NEQ = 'Returns true if both numbers are not equal to each other.';
    Blockly.Msg.LANG_MATH_COMPARE_TOOLTIP_LT = 'Returns true if the first number is smaller\n' +
        'than the second number.';
    Blockly.Msg.LANG_MATH_COMPARE_TOOLTIP_LTE = 'Returns true if the first number is smaller\n' +
        'than or equal to the second number.';
    Blockly.Msg.LANG_MATH_COMPARE_TOOLTIP_GT = 'Returns true if the first number is greater\n' +
        'than the second number.';
    Blockly.Msg.LANG_MATH_COMPARE_TOOLTIP_GTE = 'Returns true if the first number is greater\n' +
        'than or equal to the second number.';
    ...
    Blockly.Msg.LANG_MATH_ARITHMETIC_TOOLTIP_ADD = 'Returns the sum of the two numbers.';
    Blockly.Msg.LANG_MATH_ARITHMETIC_TOOLTIP_MINUS = 'Returns the difference of the two numbers.';
    Blockly.Msg.LANG_MATH_ARITHMETIC_TOOLTIP_MULTIPLY = 'Returns the product of the two numbers.';
    Blockly.Msg.LANG_MATH_ARITHMETIC_TOOLTIP_DIVIDE = 'Returns the quotient of the two numbers.';
    Blockly.Msg.LANG_MATH_ARITHMETIC_TOOLTIP_POWER = 'Returns the first number raised to\n' +
    ...
    Blockly.Msg.LANG_MATH_SINGLE_TOOLTIP_ROOT = 'Returns the square root of a number.';
    Blockly.Msg.LANG_MATH_SINGLE_HELPURL_ROOT = 'http://appinventor.mit.edu/explore/ai2/support/blocks/math#sqrt';
    Blockly.Msg.LANG_MATH_SINGLE_TOOLTIP_ABS = 'Returns the absolute value of a number.';
    Blockly.Msg.LANG_MATH_SINGLE_HELPURL_ABS = 'http://appinventor.mit.edu/explore/ai2/support/blocks/math#abs';
    Blockly.Msg.LANG_MATH_SINGLE_TOOLTIP_NEG = 'Returns the negation of a number.';
    Blockly.Msg.LANG_MATH_SINGLE_HELPURL_NEG = 'http://appinventor.mit.edu/explore/ai2/support/blocks/math#neg';
    Blockly.Msg.LANG_MATH_SINGLE_TOOLTIP_LN = 'Returns the natural logarithm of a number, i.e. the logarithm to the base e (2.71828...)';
    Blockly.Msg.LANG_MATH_SINGLE_HELPURL_LN ='http://appinventor.mit.edu/explore/ai2/support/blocks/math#log';
    Blockly.Msg.LANG_MATH_SINGLE_TOOLTIP_EXP = 'Returns e (2.71828...) to the power of a number.';
    ...
    Blockly.Msg.LANG_MATH_ROUND_TOOLTIP_ROUND = 'Rounds input number to the nearest whole number (up or down).';
    Blockly.Msg.LANG_MATH_ROUND_HELPURL_ROUND = 'http://appinventor.mit.edu/explore/ai2/support/blocks/math#round';
    Blockly.Msg.LANG_MATH_ROUND_TOOLTIP_CEILING = 'Rounds the input to the smallest whole\n' +
        'number not less than the input';
    Blockly.Msg.LANG_MATH_ROUND_HELPURL_CEILING =  'http://appinventor.mit.edu/explore/ai2/support/blocks/math#ceiling';
    Blockly.Msg.LANG_MATH_ROUND_TOOLTIP_FLOOR = 'Rounds the input to the largest whole\n' +
        'number not greater than the input';
    ...
    Blockly.Msg.LANG_MATH_TRIG_TOOLTIP_ASIN = 'Provides the angle in the range (-90,+90]\n' +
        'degrees of the given sine value.';
    ...
    Blockly.Msg.LANG_MATH_TRIG_TOOLTIP_ACOS = 'Provides the angle in the range [0, 180)\n' +
        'degrees of the given cosine value.';
    ...
    Blockly.Msg.LANG_MATH_TRIG_TOOLTIP_ATAN = 'Provides the angle in the range (-90, +90)\n' +
        'degrees of the given tangent value.';
    ...
    Blockly.Msg.LANG_MATH_TRIG_TOOLTIP_ATAN2 = 'Provides the angle in the range (-180, +180]\n' +
        'degrees of the given rectangular coordinates.';
    ...
    Blockly.Msg.LANG_MATH_ONLIST_TOOLTIP_MIN = 'Returns the smallest of its arguments.';
    Blockly.Msg.LANG_MATH_ONLIST_TOOLTIP_MAX = 'Returns the largest of its arguments.';
    ...
    Blockly.Msg.LANG_MATH_DIVIDE_TOOLTIP_MODULO = 'Returns the modulo of the inputs.';
    Blockly.Msg.LANG_MATH_DIVIDE_HELPURL_MODULO = 'http://appinventor.mit.edu/explore/ai2/support/blocks/math#modulo';
    Blockly.Msg.LANG_MATH_DIVIDE_TOOLTIP_REMAINDER = 'Returns the remainder of the inputs.';
    Blockly.Msg.LANG_MATH_DIVIDE_HELPURL_REMAINDER = 'http://appinventor.mit.edu/explore/ai2/support/blocks/math#remainder';
    Blockly.Msg.LANG_MATH_DIVIDE_TOOLTIP_QUOTIENT = 'Returns the quotient of the inputs.';
    ...
    Blockly.Msg.LANG_MATH_RANDOM_FLOAT_TOOLTIP = 'Returns a random number between 0 and 1.';
    ...
    Blockly.Msg.LANG_MATH_FORMAT_AS_DECIMAL_TOOLTIP = 'Returns the number formatted as a decimal\n' +
        'with the specified number of places.';
...
// Text Blocks.
    ...
    Blockly.Msg.LANG_TEXT_JOIN_TOOLTIP = 'Connects all of the inputs (as-is) to create a single text string.\n'
    ...
    Blockly.Msg.LANG_TEXT_APPEND_TOOLTIP = 'Appends the text to variable "%1".';
    ...
    Blockly.Msg.LANG_TEXT_LENGTH_TOOLTIP = 'Returns number of characters (including spaces)\n' +
    ...
    Blockly.Msg.LANG_TEXT_COMPARE_TOOLTIP_GT = 'Reports whether text1 is lexicographically greater than text2.\n'
        + 'If one text is the prefix of the other, the shorter text is considered smaller.\n'
        + 'Uppercase characters precede lowercase characters.';
    Blockly.Msg.LANG_TEXT_TEXT_OBSFUCATE_TOOLTIP = "Produces text that is not easily discoverable\n"
        + "by examining the app's APK. Use this when creating apps \n"
        + "that include confidential information; for example: API keys.  \n"
    ...
    Blockly.Msg.LANG_TEXT_STARTS_AT_TOOLTIP = 'Returns the starting index of the piece in the text.\n'
        + 'Index 1 denotes the beginning of the text. Returns 0 if the\n'
    ...
    Blockly.Msg.LANG_TEXT_SPLIT_AT_TOOLTIP = 'Split the text into pieces at the spaces.';
    ...
    Blockly.Msg.LANG_TEXT_SEGMENT_AT_TOOLTIP = 'Extracts the segment of the given length from the given text\n'
        + 'starting from the given position in the given text. Position\n'
...
//Blockly.Msg.LANG_LISTS_CREATE_EMPTY_TOOLTIP = 'Returns a list, of length 0, containing no data records';
    ...
    Blockly.Msg.LANG_LISTS_POSITION_IN_TOOLTIP = 'Finds the position of the thing in the list. If it\'s not in '
        + 'the list, returns 0.';
    ...
    Blockly.Msg.LANG_LISTS_PICK_RANDOM_TOOLTIP = 'Picks an item at random from the list.';
    ...
    Blockly.Msg.LANG_LISTS_REPLACE_ITEM_TOOLTIP = 'Replaces the item at \'index\' in the given list.';
    ...
    Blockly.Msg.LANG_LISTS_REMOVE_ITEM_TOOLTIP = 'Removes the item at \'index\' from the list.';
    ...
    Blockly.Msg.LANG_LISTS_APPEND_LIST_TOOLTIP = 'Appends all the items in list2 to the end of list1.\n'
        + 'After the append, list1 will include these additional elements;\n'
        + 'list2 will be unchanged.';
    ...
    Blockly.Msg.LANG_LISTS_IS_LIST_TOOLTIP = 'Tests if the thing is a list.';
    ...
    Blockly.Msg.LANG_LISTS_TO_CSV_ROW_TOOLTIP = 'Interprets the list as a row of a table and returns a CSV'
        + '\(comma-separated value\) text representing the row.\n'
        + 'Each item in the row list is considered to be a field,\n'
        + 'and is quoted with double-quotes in the resulting CSV text.\n'
        + 'Items are separated by commas. The returned row text does not have\n'
    ...
    Blockly.Msg.LANG_LISTS_FROM_CSV_ROW_TOOLTIP = 'Parses the text as a CSV \(comma-separated value\) formatted row\n'
        + 'to produce a list of fields. It is an error for the row text\n'
        + 'to contain unescaped newlines inside fields \(effectively, multiple lines\).\n'
        + 'It is okay for the row text to end in a single newline or CRLF.';
    ...
    Blockly.Msg.LANG_LISTS_TO_CSV_TABLE_TOOLTIP = 'Interprets the list as a table in row-major format and\n'
        + 'returns a CSV \(comma-separated value\) text representing the table.\n'
        + 'Each item in the list should itself be a list representing a row of the CSV table.\n'
        + 'Each item in the row list is considered to be a field,\n'
        + 'and is quoted with double-quotes in the resulting CSV text.\n'
        + 'In the returned text, items in rows are separated by commas\n'
        + 'and rows are separated by CRLF, i.e. \(\\r\\n\).';
    ...
    Blockly.Msg.LANG_LISTS_FROM_CSV_TABLE_TOOLTIP = 'Parses the text as a CSV \(comma-separated value\) formatted table\n'
        + 'to produce a list of rows, each of which is a list of fields.\n'
    ...
    Blockly.Msg.LANG_LISTS_INSERT_TOOLTIP = 'Inserts an item into a list at \'index\'.';
...
// Variables Blocks.
    ...
    Blockly.Msg.LANG_VARIABLES_GLOBAL_DECLARATION_TOOLTIP = 'Creates a global variable and gives it the value of the '
        + 'attached block(s).';
    ...
    Blockly.Msg.LANG_VARIABLES_SET_TOOLTIP = 'Sets the value of this variable to be equal to the input.';
...
// Procedures Blocks.
    ...
    Blockly.Msg.LANG_PROCEDURES_CALLNORETURN_TOOLTIP = 'Calls \'procedure\' with no return value.';
    ...
    Blockly.Msg.LANG_PROCEDURES_CALLRETURN_TOOLTIP = 'Calls \'procedure\' with a return value.';
...
//Misc
    ...
    Blockly.Msg.WRONG_TYPE_BLOCK_WARNINGS = "This block should be connected to an event block or a procedure "
    + "definition.";
...
// Messages from replmgr.js
    ...
    Blockly.Msg.REPL_NOW_DOWNLOADING = "We are now downloading the update from the App Inventor Server. Please standby";
    ...
    Blockly.Msg.REPL_HELPER_NOT_RUNNING = 'The aiStarter helper program does not appear to be running.<br /><a href="http://http://appinventor.mit.edu/explore/ai2/setup-emulator.html" target="_blank">Need Help?</a>';
