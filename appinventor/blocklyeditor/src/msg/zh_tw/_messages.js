...
init: function() {
    ...
    Blockly.Msg.LANG_CONTROLS_FORRANGE_TOOLTIP = '按指定範圍和增量循環取值，每次循環均將數值賦予指定變數，並執行「執行」區域所包含的程式方塊';
    ...
    Blockly.Msg.LANG_CONTROLS_WHILE_TOOLTIP = '“執行”區域中程式方塊被執行的前提是，滿足條件的表達式值為'
    + 'True。';
    ...
    Blockly.Msg.LANG_CONTROLS_CHOOSE_TOOLTIP = '如果條件表達式的檢測值為True，' +
    ...
    + '如果首字母相同，則長度較短的文字順序靠前，\n'
    + '大寫字元順序優於小寫字元。';
    Blockly.Msg.LANG_TEXT_COMPARE_TOOLTIP_EQUAL = '檢測文字字串內容是否相同，即，\n'
    + '是否由同一組相同順序的字元組成，與通常的相等概念不同的是，\n'
    + '當文字字串為數字時，如123和0123，儘管數字相等，\n'
    + '但其文字不等。';
    ...
    Blockly.Msg.LANG_TEXT_SPLIT_TOOLTIP_SPLIT = '以指定文字作為分隔符號，將字元串分解為不同片段，並生成一個清單作為傳回結果。\n'
    ...
    Blockly.Msg.LANG_LISTS_IS_IN_INPUT = '檢查查清單%2中是否含清單項%1'
    ...
    Blockly.Msg.LANG_LISTS_ADD_ITEMS_TITLE_ADD = '增加清單項';
    Blockly.Msg.LANG_LISTS_ADD_ITEMS_INPUT_LIST = '清單';
    Blockly.Msg.LANG_LISTS_ADD_ITEMS_INPUT_ITEM = '清單項';
    Blockly.Msg.LANG_LISTS_ADD_ITEMS_INPUT = '將清單項%2加入清單%1中';
    Blockly.Msg.LANG_LISTS_ADD_ITEMS_TOOLTIP = '在清單末尾增加清單項';
    ...
    Blockly.Msg.LANG_LISTS_IS_LIST_TOOLTIP = '檢測該對象是否為清單類型';
    ...
    + '生成一個包含各字段數據的清單。對於文字行而言，如字段中出現非轉義的換行符號則會出錯'
    ...
    Blockly.Msg.LANG_LISTS_LOOKUP_IN_PAIRS_INPUT = '在鍵值對%2中查找關鍵字%1 如未找到則傳回%3';
    Blockly.Msg.LANG_LISTS_LOOKUP_IN_PAIRS_TOOLTIP = '傳回鍵值對清單中與關鍵字關聯的數值';
    ...
    Blockly.Msg.MISSING_SOCKETS_WARNINGS = "您應該為模塊的每個埠號都填上模塊";
    Blockly.Msg.WRONG_TYPE_BLOCK_WARINGS = "這個模塊應該連上事件或者程序模塊";
    ...
    Blockly.Msg.REPL_UPDATE_INFO = '正在安裝升級包，請在設備（或模擬器）上檢查確認。<br /><br />註意：升級完成後，請選擇“完成”（不要選開啟）。然後在瀏覽器中開啟並進入App Inventor，點選“連接設備”並選擇“重置連接”項。';
    ...
    Blockly.Msg.REPL_NO_ERROR_FIVE_SECONDS ="<br/><i>註意：</i>&nbsp;5秒鐘後將顯示另一個錯誤訊息。";
