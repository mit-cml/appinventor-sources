...
Blockly.Msg.ar.switch_language_to_arabic = {
  ...
  init: function() {
// Context menus.
    Blockly.Msg.UNDO = 'تراجع';
    Blockly.Msg.REDO = 'افعل ثانية';
    Blockly.Msg.CLEAN_UP = 'تنظيف الكتل';
    Blockly.Msg.DUPLICATE_BLOCK = 'كرر';
    Blockly.Msg.REMOVE_COMMENT = 'امسح التعليق';
    Blockly.Msg.ADD_COMMENT = 'اضافة تعليق';
    Blockly.Msg.EXTERNAL_INPUTS = 'المدخلات الخارجية';
    Blockly.Msg.INLINE_INPUTS = 'مدخلات مضمنة';
    Blockly.Msg.HORIZONTAL_PARAMETERS = 'ترتيب المعلمات افقيا';
    Blockly.Msg.VERTICAL_PARAMETERS = 'ترتيب المعلمات عموديا';
    Blockly.Msg.CONFIRM_DELETE = 'Confirm deletion';
    Blockly.Msg.DELETE_ALL_BLOCKS = "مسح جميع الكتل?";
    Blockly.Msg.DELETE_BLOCK = 'مسح الكتلة';
    Blockly.Msg.DELETE_X_BLOCKS = 'مسح الكتل';
    Blockly.Msg.COLLAPSE_BLOCK = 'طي الكتل';
    Blockly.Msg.EXPAND_BLOCK = 'فرد الكتل';
    Blockly.Msg.DISABLE_BLOCK = 'تعطيل الكتلة';
    Blockly.Msg.ENABLE_BLOCK = 'تفعيل الكتلة';
...
// Variable renaming.
    Blockly.MSG_CHANGE_VALUE_TITLE = 'تغيير القيمة :';
    Blockly.MSG_NEW_VARIABLE = 'متغير جديد ...';
    Blockly.MSG_NEW_VARIABLE_TITLE = 'اسم المتغير الجديد :';
    Blockly.MSG_RENAME_VARIABLE = 'اعادة تسمية المتغير.';
    Blockly.MSG_RENAME_VARIABLE_TITLE = 'Rename all "%1" variables to:';

// Toolbox.
    Blockly.MSG_VARIABLE_CATEGORY = 'متغيرات';
    Blockly.MSG_PROCEDURE_CATEGORY = 'الإجراءات';
...
// Colour Blocks.
    ...
    Blockly.Msg.LANG_COLOUR_BLACK = 'اسود';
    Blockly.Msg.LANG_COLOUR_WHITE = 'ابيض';
    Blockly.Msg.LANG_COLOUR_RED = 'احمر';
    Blockly.Msg.LANG_COLOUR_PINK = 'زهري';
    Blockly.Msg.LANG_COLOUR_ORANGE = 'برتقالي';
    Blockly.Msg.LANG_COLOUR_YELLOW = 'اصفر';
    Blockly.Msg.LANG_COLOUR_GREEN = 'اخضر';
    Blockly.Msg.LANG_COLOUR_CYAN = 'ازرق سماوي';
    Blockly.Msg.LANG_COLOUR_BLUE = 'ازرق';
    Blockly.Msg.LANG_COLOUR_MAGENTA = 'أرجواني';
    Blockly.Msg.LANG_COLOUR_LIGHT_GRAY = 'سكني فاتح';
    Blockly.Msg.LANG_COLOUR_DARK_GRAY = 'سكني غامق';
    Blockly.Msg.LANG_COLOUR_GRAY = 'سكني';
    Blockly.Msg.LANG_COLOUR_SPLIT_COLOUR = 'فكك لون';
    ...
    Blockly.Msg.LANG_COLOUR_MAKE_COLOUR = 'ركب لون';
...
// Control Blocks
    ...
    Blockly.Msg.LANG_CONTROLS_IF_MSG_IF = 'اذا';
    Blockly.Msg.LANG_CONTROLS_IF_MSG_ELSEIF = 'وإلا إذا';
    Blockly.Msg.LANG_CONTROLS_IF_MSG_ELSE = 'وإلا';
    Blockly.Msg.LANG_CONTROLS_IF_MSG_THEN = 'ثم';

    Blockly.Msg.LANG_CONTROLS_IF_IF_TITLE_IF = 'اذا';
    Blockly.Msg.LANG_CONTROLS_IF_IF_TOOLTIP = 'اضافة, حذف, or reorder sections\n' +
        'to reconfigure this if block.';

    Blockly.Msg.LANG_CONTROLS_IF_ELSEIF_TITLE_ELSEIF = 'وإلا إذا';
    Blockly.Msg.LANG_CONTROLS_IF_ELSEIF_TOOLTIP = 'Add a condition to the if block.';

    Blockly.Msg.LANG_CONTROLS_IF_ELSE_TITLE_ELSE = 'وإلا';
...
// Blocklyeditor.js
    ...
    Blockly.Msg.DO_IT = "نفذ";
    Blockly.Msg.CLEAR_DO_IT_ERROR = "مسح الخطاء";
    Blockly.Msg.CAN_NOT_DO_IT = "لا يمكن التنفيذ";
    Blockly.Msg.CONNECT_TO_DO_IT = 'يجب ان تكون متصلا بالمحاكي لتشغبل  "نفذ"';

// Clock Component Menu Items
    Blockly.Msg.TIME_YEARS = "سنوات";
    Blockly.Msg.TIME_MONTHS = "اشهر";
    Blockly.Msg.TIME_WEEKS = "اسابيع";
    Blockly.Msg.TIME_DAYS = "ايام";
    Blockly.Msg.TIME_HOURS = "ساعات";
    Blockly.Msg.TIME_MINUTES = "دقائق";
    Blockly.Msg.TIME_SECONDS = "ثواني";
    Blockly.Msg.TIME_DURATION = "المدة";
  }
};
