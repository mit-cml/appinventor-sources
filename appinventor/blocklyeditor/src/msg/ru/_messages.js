...
Blockly.Msg.ru.switch_language_to_russian = {
  ...
  init: function() {
    ...
    Blockly.Msg.LANG_LISTS_APPEND_LIST_INPUT = 'добавить к списку  список1 % список2 %2';
    ...
    Blockly.Msg.LANG_MATH_CONSTRAIN_INPUT_CONSTRAIN = 'ограничивать';
    Blockly.Msg.LANG_MATH_CONSTRAIN_INPUT_HIGH = 'и (высокий)';
    Blockly.Msg.LANG_MATH_CONSTRAIN_INPUT_LOW = 'между (низкий)';
    ...
    Blockly.Msg.LANG_MATH_ONLIST_INPUT_OFLIST = 'из списка';
    Blockly.Msg.LANG_MATH_ONLIST_OPERATOR_AVERAGE = 'среднее';
    Blockly.Msg.LANG_MATH_ONLIST_OPERATOR_MAX = 'max';
    Blockly.Msg.LANG_MATH_ONLIST_OPERATOR_MEDIAN = 'медиана';
    Blockly.Msg.LANG_MATH_ONLIST_OPERATOR_MIN = 'мин.';
    Blockly.Msg.LANG_MATH_ONLIST_OPERATOR_MODE = 'режимы';
    Blockly.Msg.LANG_MATH_ONLIST_OPERATOR_RANDOM = 'случайный элемент';
    Blockly.Msg.LANG_MATH_ONLIST_OPERATOR_STD_DEV = 'стандартное отклонение';
    Blockly.Msg.LANG_MATH_ONLIST_OPERATOR_SUM = 'sum';
    Blockly.Msg.LANG_MATH_ONLIST_TOOLTIP_AVERAGE = 'Возвращает среднее арифметическое списка.';
    Blockly.Msg.LANG_MATH_ONLIST_TOOLTIP_MAX = 'Возвращает наибольшее число списка..';
    Blockly.Msg.LANG_MATH_ONLIST_TOOLTIP_MEDIAN = 'Возвращает медиану списка.';
    Blockly.Msg.LANG_MATH_ONLIST_TOOLTIP_MIN = 'Возвращает минимальный элемент..';
    Blockly.Msg.LANG_MATH_ONLIST_TOOLTIP_MODE = 'Вернуть список наиболее часто встречающихся пунктов из списка.';
    Blockly.Msg.LANG_MATH_ONLIST_TOOLTIP_RANDOM = 'Возвращает случайный элемент списка.';
    Blockly.Msg.LANG_MATH_ONLIST_TOOLTIP_STD_DEV = 'Возвращает стандартное отклонение списка.';
    Blockly.Msg.LANG_MATH_ONLIST_TOOLTIP_SUM = 'Возвращает сумму всех чисел в списке.';
