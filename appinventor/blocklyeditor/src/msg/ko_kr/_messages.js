...
Blockly.Msg.ko.switch_language_to_korean = {
  ...
  init: function() {
    ...
    Blockly.Msg.LANG_CONTROLS_WHILE_TOOLTIP = '테스트가 \'true\'인 동안 \'do\'섹션에서 블록을 실행합니다. \'';
    ...
    Blockly.Msg.LANG_TEXT_STARTS_AT_TOOLTIP = '텍스트의 조각의 시작 인덱스를 반환합니다. 여기서 인덱스 1은 텍스트의 시작을 나타냅니다. 조각이 텍스트에 없으면 0을 반환합니다.';
    ...
    Blockly.Msg.LANG_LISTS_IS_IN_INPUT = '리스트에서 항목 위치 가져오기  항목 %1 리스트 %2';
    Blockly.Msg.LANG_LISTS_IS_IN_TOOLTIP = '항목이 목록의 항목이면 \'true\'를 반환하고 그렇지 않으면 \'false\'를 반환합니다.';
    ...
    Blockly.Msg.LANG_LISTS_REVERSE_TITLE_REVERSE = '리스트 역순으로 바꾸기';
    ...
    Blockly.Msg.LANG_LISTS_JOIN_WITH_SEPARATOR_INPUT = '아이템 결합하기 구분자 %1 리스트 %2';
    ...
    Blockly.Msg.LANG_VARIABLES_SET_TITLE_TO = '끝';
    Blockly.Msg.LANG_VARIABLES_SET_COLLAPSED_TEXT = '지정하기';
    Blockly.Msg.LANG_VARIABLES_SET_TOOLTIP = '이 변수를 입력 값과 같게 설정합니다.';
    Blockly.Msg.LANG_VARIABLES_VARIABLE = '변하기 쉬운';
    Blockly.Msg.LANG_VARIABLES_LOCAL_DECLARATION_TITLE_INIT = '지역 초기화';
    Blockly.Msg.LANG_VARIABLES_LOCAL_DECLARATION_DEFAULT_NAME = '이름';
    Blockly.Msg.LANG_VARIABLES_LOCAL_DECLARATION_INPUT_TO = '끝';
    ...
    Blockly.Msg.LANG_VARIABLES_LOCAL_DECLARATION_TRANSLATED_NAME = 'do에서 로컬 초기화';
    ...
    Blockly.Msg.LANG_PROCEDURES_DEFNORETURN_DEFINE = '끝';
    Blockly.Msg.LANG_PROCEDURES_DEFNORETURN_PROCEDURE = '함수 만들기';
    Blockly.Msg.LANG_PROCEDURES_DEFNORETURN_DO = '실행';
    Blockly.Msg.LANG_PROCEDURES_DEFNORETURN_COLLAPSED_PREFIX = '끝';
    ...
    Blockly.Msg.LANG_PROCEDURES_DEFRETURN_DEFINE = '끝';
    Blockly.Msg.LANG_PROCEDURES_DEFRETURN_RETURN = '결과값 반환';
    Blockly.Msg.LANG_PROCEDURES_DEFRETURN_COLLAPSED_PREFIX = '끝';
