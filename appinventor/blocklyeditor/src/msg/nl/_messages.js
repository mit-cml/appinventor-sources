...
Blockly.Msg.nl.switch_language_to_dutch = {
  ...
  init: function() {
    ...
    Blockly.Msg.VARIABLE_CATEGORY = 'Variabelen';
    ...
    Blockly.Msg.ERROR_SELECT_VALID_ITEM_FROM_DROPDOWN = 'Selecteer een geldig item uit de drop down.';
    ...
    Blockly.Msg.CHANGE_VALUE_TITLE = 'Wijzig waarde:';
    ...
    Blockly.Msg.ERROR_DUPLICATE_EVENT_HANDLER = 'Dit een een copy van een signaalafhandelaar voor deze component.';
    ...
    Blockly.Msg.ERROR_BLOCK_CANNOT_BE_IN_DEFINTION = 'Dit blok kan niet in een definitie';
    ...
    Blockly.Msg.RENAME_VARIABLE = 'Geef variabele een andere naam...';
