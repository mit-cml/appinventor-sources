...
Blockly.Msg.pl.switch_language_to_polish = {
  ...
  init: function() {
    ...
    Blockly.Msg.LANG_CONTROLS_FORRANGE_TOOLTIP = 'Uruchamia bloki w sekcji „wykonaj” dla każdej wartości liczbowej w zakresie od początku do końca, zwiększając wartość za każdym razem. Użyj podanej nazwy zmiennej, aby odnieść się do bieżącej value.lockly.Msg.LANG_CONTROLS_FOREACH_HELPURL = \' /reference/blocks/control.html#foreach';
    ...
    Blockly.Msg.LANG_CONTROLS_FOREACH_TOOLTIP = 'Uruchamia bloki w sekcji „wykonaj” dla każdego elementu na liście. Użyj podanej nazwy zmiennej, aby odnieść się do bieżącej listy item.lockly.Msg.LANG_CONTROLS_GET_HELPURL = \'/reference/blocks/control.html#get';
    ...
    Blockly.Msg.LANG_CONTROLS_WHILE_TOOLTIP = 'Uruchamia bloki w sekcji „wykonaj”, gdy test jest „true.lockly.Msg.LANG_CONTROLS_CHOOSE_HELPURL = \'” /reference/blocks/control.html#choose';
    Blockly.Msg.LANG_CONTROLS_CHOOSE_TITLE = 'if\'Blockly.Msg.LANG_CONTROLS_CHOOSE_INPUT_TEST = \'';
    ...
    Blockly.Msg.LANG_CONTROLS_EVAL_BUT_IGNORE_TITLE = 'oceniaj, ale ignoruj wynik \'Blockly.Msg.LANG_CONTROLS_EVAL_BUT_IGNORE_HELPURL = \' /reference/blocks/control.html#evaluate';
    Blockly.Msg.LANG_CONTROLS_EVAL_BUT_COLLAPSED_TEXT = 'oceń ale ignoruj \'Blockly.Msg.LANG_CONTROLS_EVAL_BUT_IGNORE_TOOLTIP = \' Uruchamia połączony blok kodu i ignoruje zwracaną wartość (jeśli istnieje). Przydatne, jeśli trzeba wywołać procedurę z wartością zwracaną, ale nie potrzebujesz wartości.';
    ...
    Blockly.Msg.LANG_CONTROLS_OPEN_ANOTHER_SCREEN_WITH_START_VALUE_COLLAPSED_TEXT = 'otwórz ekran o wartości \'Blockly.Msg.LANG_CONTROLS_OPEN_ANOTHER_SCREEN_WITH_START_VALUE_TOOLTIP = \' Otwiera nowy ekran w aplikacji wieloekranowej i przekazuje wartość początkową \' do tego ekranu.lockly.Msg.LANG_CONTROLS_GET_START_VALUE_HELPURL = \' /reference/blocks/control.html #getstartvalue';
    ...
    Blockly.Msg.LANG_CONTROLS_GET_START_VALUE_TOOLTIP = 'Zwraca wartość, która została przekazana do tego ekranu, gdy został otwarty, zazwyczaj przez inny ekran w aplikacji wieloekranowej. Jeśli nie przekazano żadnej wartości, zwraca pusty tekst.lockly.Msg.LANG_CONTROLS_CLOSE_SCREEN_HELPURL = \' /reference/blocks/control.html#closescreen';
    ...
    Blockly.Msg.LANG_CONTROLS_CLOSE_SCREEN_WITH_VALUE_TOOLTIP = 'Zamyka bieżący ekran i zwraca wynik na ekran \', który go otworzył..lockly.Msg.LANG_CONTROLS_CLOSE_APPLICATION_HELPURL = \'/reference/blocks/control.html#closeapp';
    ...
    Blockly.Msg.LANG_CONTROLS_GET_PLAIN_START_TEXT_TOOLTIP = 'Zwraca zwykły tekst przekazany na ten ekran, gdy został uruchomiony przez inną aplikację. Jeśli nie przekazano żadnej wartości, zwraca pusty tekst. W przypadku aplikacji z wieloma ekranami, użyj uzyskaj wartość początkową zamiast zacznij..lockly.Msg.LANG_CONTROLS_CLOSE_SCREEN_WITH_PLAIN_TEXT_HELPURL = \'/reference/blocks/control.html#closescreenwithplaintext';
    ...
    Blockly.Msg.LANG_TEXT_TRIM_TOOLTIP = 'Zwraca kopię argumentów ciągu tekstowego z usuniętymi spacjami początkowymi lub końcowymi.lockly.Msg.LANG_TEXT_STARTS_AT_HELPURL = \' /reference/blocks/text.html#startsat';
    ...
    Blockly.Msg.LANG_TEXT_STARTS_AT_TOOLTIP = 'Zwraca indeks początkowy utworu w tekście. „”, gdzie indeks 1 oznacza początek tekstu. Zwraca 0, jeśli element nie jest w text.lockly.Msg.LANG_TEXT_CONTAINS_HELPURL = \' /reference/blocks/text.html#contains';
    ...
    Blockly.Msg.LANG_TEXT_SPLIT_TOOLTIP_SPLIT_AT_FIRST = 'Dzieli dany tekst na dwie części, wykorzystując położenie pierwszego wystąpienia „„ tekstu ”„ w ”jako punktu podziału, i zwraca listę dwóch elementów, składającą się z części przed punktem podziału i części po podziale punkt. Podział „jabłko, banan, wiśnia, pies” z przecinkiem jako punkt podziału zwraca listę dwóch elementów: pierwszy to tekst „jabłko”, a drugi to tekst „banan, wiśnia, karma dla psów”. Zauważ, że przecinek po „jabłku” nie pojawia się w wyniku, ponieważ jest to punkt podziału.lockly.Msg.LANG_TEXT_SPLIT_HELPURL_SPLIT_AT_FIRST = \' /reference/blocks/text.html#splitat';
    Blockly.Msg.LANG_TEXT_SPLIT_TOOLTIP_SPLIT_AT_FIRST_OF_ANY = 'Dzieli dany tekst na listę dwuelementową, wykorzystując pierwszą lokalizację dowolnego elementu „na liście” jako „punkt podziału”. Podział „Kocham jabłka banany winogrona jabłkowe” na liście „(ba, ap)” zwraca listę dwóch elementów, z których pierwszym jest „Kocham”, a drugim „ples banany winogrona jabłkowe”. Lockly.Msg.LANG_TEXT_SPLIT_HELPURL_SPLIT_AT_FIRST_OF_ANY = \' /reference/blocks/text.html#splitatfirstofany';
    Blockly.Msg.LANG_TEXT_SPLIT_TOOLTIP_SPLIT = 'Dzieli tekst na kawałki, używając tekstu „” w „” jako punktów podziału i tworzy listę wyników. \' Podział „jeden, dwa, trzy, cztery” na „,” (przecinek) zwraca listę ”(jeden dwa trzy cztery)”. Podział „jeden-ziemniak, dwa-ziemniak, trzy-ziemniak, cztery” w „-potato”, zwraca listę ”(jeden dwa trzy cztery)”. Lockly.Msg.LANG_TEXT_SPLIT_HELPURL_SPLIT = \' /reference/blocks/text.html #rozdzielać';
    Blockly.Msg.LANG_TEXT_SPLIT_TOOLTIP_SPLIT_AT_ANY = 'Dzieli dany tekst na listę, używając dowolnego elementu z listy „na” jako „punktu podziału” i zwraca listę wyników. Dzielenie „appleberry, banana, cherry, dogfood” z „\'at” ”jako dwuelementowej listy, której pierwszym elementem jest przecinek, a którego drugim elementem jest„ rry ”, zwraca listę czterech przedmiotów:„ (applebe banana che dogfood) \".lockly.Msg.LANG_TEXT_SPLIT_HELPURL_SPLIT_AT_ANY = \' /reference/blocks/text.html#splitatany';
    ...
    Blockly.Msg.LANG_TEXT_SEGMENT_AT_TOOLTIP = 'Wyodrębnia segment o podanej długości z podanego tekstu „”, zaczynając od podanego tekstu począwszy od podanej pozycji. Pozycja 1 oznacza początek text.lockly.Msg.LANG_TEXT_REPLACE_ALL_HELPURL = \' /reference/blocks/text.html#replaceall';
    ...
    Blockly.Msg.LANG_TEXT_REPLACE_ALL_TOOLTIP = 'Zwraca nowy tekst uzyskany przez zastąpienie wszystkich wystąpień \' segmentu przez replacement.lockly.Msg.LANG_TEXT_TEXT_IS_STRING_HELPURL = \' /reference/blocks/text.html#isstring';
    ...
    Blockly.Msg.LANG_LISTS_IS_IN_INPUT = 'jest na liście? obiekt %1 lista %2\'Blockly.Msg.LANG_LISTS_IS_IN_TOOLTIP = \' Zwraca Prawda, jeśli obiekt jest elementem na liście i Fałsz jeśli nie.lockly.Msg.LANG_LISTS_POSITION_IN_HELPURL = \' / reference / blocks / lists .html # indexinlist';
    ...
    Blockly.Msg.LANG_LISTS_POSITION_IN_TOOLTIP = 'Znajdź pozycję obiektów na liście. Jeśli nie ma go w liście, zwróć 0.lockly.Msg.LANG_LISTS_PICK_RANDOM_ITEM_HELPURL = \' /reference/blocks/lists.html#pickrandomitem';
    ...
    Blockly.Msg.LANG_LISTS_APPEND_LIST_TOOLTIP = 'Dołącza wszystkie elementy z listy2 na końcu listy1. Po dołączeniu „” lista1 będzie zawierać te dodatkowe elementy, ale lista2 będzie niezmieniona.lockly.Msg.LANG_LISTS_ADD_ITEMS_HELPURL = \' /reference/blocks/lists.html#additems';
    ...
    Blockly.Msg.LANG_LISTS_FROM_CSV_ROW_TOOLTIP = 'Analizuje tekst jako sformatowany wiersz „” w formacie CSV (wartość rozdzielana przecinkami), aby utworzyć listę pól. Jest błędem, że tekst wiersza zawiera niezmienione znaki nowej linii wewnątrz pól (efektywnie, wiele linii). Tekst wiersza może kończyć się pojedynczym znakiem nowej linii lub CRLF.lockly.Msg.LANG_LISTS_TO_CSV_TABLE_HELPURL = \' /reference/blocks/lists.html#listtocsvtable';
    Blockly.Msg.LANG_LISTS_TO_CSV_TABLE_TITLE_TO_CSV = 'lista do tabeli CSV';
    Blockly.Msg.LANG_LISTS_TO_CSV_TABLE_INPUT_LIST = 'lista';
    Blockly.Msg.LANG_LISTS_TO_CSV_TABLE_TOOLTIP = 'Interpretuje listę jako tabelę w formacie głównym wiersza, a „” zwraca tekst CSV (wartość rozdzielana przecinkami) reprezentujący tabelę. Każda pozycja na liście powinna sama być listą reprezentującą wiersz tabeli CSV. Każdy element na liście wierszy jest uważany za pole i jest cytowany z cudzysłowami w wynikowym tekście CSV. W zwróconym tekście elementy w wierszach są oddzielone przecinkami, a wiersze oddzielone są CRLF () .lockly.Msg.LANG_LISTS_FROM_CSV_TABLE_HELPURL = \' /reference/blocks/lists.html#listfromcsvtable';
    ...
    Blockly.Msg.LANG_LISTS_FROM_CSV_TABLE_TOOLTIP = 'Analizuje tekst jako sformatowaną tabelę „” w formacie CSV (wartość rozdzielana przecinkami), aby utworzyć listę wierszy, z których każdy jest listą pól. Wiersze mogą być rozdzielone znakami newlines () lub CRLF () .lockly.Msg.LANG_LISTS_INSERT_ITEM_HELPURL = \' /reference/blocks/lists.html#insert';
