...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CSLinearLayoutView/CSLinearLayoutView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GCDWebServer/GCDWebServer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/JSONWebToken/JSONWebToken.framework"
