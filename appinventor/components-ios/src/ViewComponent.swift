...
@objc public protocol AbstractMethodsForViewComponent: AnyObject {
  var view: UIView { get }
}

@objc open class ViewComponent: NSObject, VisibleComponent {
  private unowned var _delegate: AbstractMethodsForViewComponent!
  @objc public unowned let container: ComponentContainer
