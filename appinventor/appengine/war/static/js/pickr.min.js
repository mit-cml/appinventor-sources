  ...
  return (function (t) {
    ...
    function (t, e, o) {
      ...
      function u(t, e = (t) => t) {
        ...
        r(t, "focus", () => r(window, "wheel", o, { passive: !1 })),
        ...
        t: for (const i in e) {
          ...
          switch (i) {
            case "cmyk": {
              ...
              return { values: y(t, e, r, s), type: i };
            }
            case "rgba": {
              const [, , , t, e, s, a] = o(n);
              if (t > 255 || e > 255 || s > 255 || a < 0 || a > 1 || !r(a))
                break t;
              return { values: [...g(t, e, s), a], a: a, type: i };
            }
            case "hexa": {
              let [, t] = n;
      ...
      function $(t) {
        ...
        return (
          ...
          r([o.wrapper, o.element], "touchstart", n, { passive: !1 }),
      ...
      class x {
        constructor(t) {
          ...
          (o.opacity = !r && l),
            ...
            this._bindEvents(),
            this._finalBuild(),
            e && Object.keys(e).length && Object.keys(e).forEach((t) => this.addSwatch(t, e[t])),
            e2 && e2.length && e2.forEach((t) => this.addSwatch2(t));
          const { button: u, app: h } = this._root;
          (this._nanopop = E(u, h, { margin: s })),
            ...
            const {
              ...
              p = l(
                `\n      <div :ref="root" class="pickr">\n\n        ${
                  ...
                  "aria:opacity"
                )}" role="slider"></div>\n            </div>\n          </div>\n\n<p class="colorPickerHeading">Default Colors</p>          <div class="pcr-swatches ${
                  e.palette ? "" : "pcr-last"
                }" :ref="swatches"></div>\n\n <p class="colorPickerHeading2">Project Colors</p>    <div class="pcr-swatches ${
                  e.palette ? "" : "pcr-last"
                  ...
                  "btn:save"
                )}" type="button" ${a(e.interaction.save)} aria-label="${c(
                  "aria:btn:save"
                )}">\n            <input :ref="cancel" class="pcr-cancel" value="${c(
                  "btn:cancel"
                )}" type="button" ${a(e.interaction.cancel)} aria-label="${c(
                  "aria:btn:cancel"
                )}">\n            <input :ref="clear" class="pcr-clear" value="${c(
                  "btn:clear"
                )}" type="button" ${a(e.interaction.clear)} aria-label="${c(
                  "aria:btn:clear"
                )}">\n          </div>\n        </div>\n      </div>\n    `
              ),
              u = p.interaction;
          ...
          if (e) {
            ...
            n = C(...e),
              ...
              i = `<div><button type="button" style="color: ${n
                .toRGBA()
                .toString(0)}" aria-label="color-swatch"</button></div><p class="swatch-text">${colorName}</p>`;
              element.innerHTML = i;
            return (
              o.swatches.appendChild(element),
              t.push({ el: element, color: n }),
        ...
        addSwatch2(t) {
          ...
          if (e) {
            const { _swatchColors: t, _root: o } = this,
              ...
              i = `<div><button type="button" style="color: ${n
                .toRGBA()
                .toString(0)}" aria-label="color-swatch"</button></div><p class="swatch-text">${t}</p>`;
              element.innerHTML = i;
            return (
              o.swatches2.appendChild(i),
              t.push({ el: element, color: n }),
              this._eventBindings.push(
                r(element, "click", () => {
                  this.setHSVA(...n.toHSVA(), !0),
