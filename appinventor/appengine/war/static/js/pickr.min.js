/*! Pickr 1.8.0 MIT | https://github.com/Simonwep/pickr */ !(function(t, e) {
    ...
    return (function(t) {
        ...
        function(t, e, o) {
            ...
            function u(t, e = (t) => t) {
                function o(o) {
                    const n = [0.001, 0.01, 0.1][Number(o.shiftKey || 2 * o.ctrlKey)] *
                        (o.deltaY < 0 ? 1 : -1);
                    let i = 0,
                        r = t.selectionStart;
           ...
           e.interaction.cancel
                ...
                addSwatch2(t, colorName) {
                    ...
                    if (e) {
                        ...
                        n = C(...e),
                            element = document.createElement("div");
                        element.className = "swatch-container";
                        // element.dataset.color = colorName;
              ...
              <div class="delete-btn" title="Remove color">×</div>
                ...
                removeSwatch(t) {
                    ...
                    if (e) {
                        ...
                        return (
                            ...
                            this._swatchColors.splice(t, 1), !0
                        );
                    }
                    return !1;
                }
                ...
                setColorRepresentation(t) {
                    return (
                        (t = t.toUpperCase()), !!this._root.interaction.options.find(
