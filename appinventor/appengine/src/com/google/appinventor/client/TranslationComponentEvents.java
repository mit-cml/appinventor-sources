...
public class TranslationComponentEvents {
  ...
  public static HashMap<String, EventPair> englishMap() { 
    ...
    map.put("LongClick", new EventPair("LongClick", "LongClick"));
    map.put("AfterDateSet", new EventPair("AfterDateSet", "AfterDateSet"));
    map.put("TagRead", new EventPair("TagRead", "TagRead"));
    map.put("TagWritten", new EventPair("TagWritten", "TagWritten"));
    map.put("PositionChanged", new EventPair("PositionChanged", "PositionChanged"));
    map.put("AfterSelecting", new EventPair("AfterSelecting", "AfterSelecting"));
    map.put("AfterTimeSet", new EventPair("AfterTimeSet", "AfterTimeSet"));
    map.put("GotTranslation", new EventPair("GotTranslation", "GotTranslation"));
  ...
  public static Map<String, EventPair> chineseMap() {
    ...
    map.put("LocationChanged", new EventPair("LocationChanged", "地点已更改"));
    map.put("StatusChanged", new EventPair("StatusChanged", "状态已改变"));
    
    map.put("AfterChoosing", new EventPair("AfterChoosing", "选择后"));
    map.put("AfterTextInput", new EventPair("AfterTextInput", "文字输入后"));
    map.put("AboveRange", new EventPair("AboveRange", "上述范围"));
    map.put("BelowRange", new EventPair("BelowRange", "下面范围"));
    map.put("ColorChanged", new EventPair("ColorChanged", "颜色改变"));
    map.put("WithinRange", new EventPair("WithinRange", "范围内"));
    map.put("Pressed", new EventPair("Pressed", "按下"));
    map.put("Released", new EventPair("Released", "发布"));
    map.put("OrientationChanged", new EventPair("OrientationChanged", "取向改变"));
    map.put("CalibrationFailed", new EventPair("CalibrationFailed", "校准失败"));
    map.put("GPSAvailable", new EventPair("GPSAvailable", "GPS可用"));
    map.put("GPSLost", new EventPair("GPSLost", "GPS丢失"));
    map.put("SimpleStep", new EventPair("SimpleStep", "简单的步骤"));
    
    map.put("StartedMoving", new EventPair("StartedMoving", "开始移动"));
    map.put("StoppedMoving", new EventPair("StoppedMoving", "停止移动"));
    map.put("WalkStep", new EventPair("WalkStep", "步行步"));
    map.put("Completed", new EventPair("Completed", "已完成"));
    map.put("AfterSoundRecorded", new EventPair("AfterSoundRecorded", "录製的声音后"));
    map.put("StartedRecording", new EventPair("StartedRecording", "开始录製"));
    map.put("StoppedRecording", new EventPair("StoppedRecording", "停止记录"));
    map.put("AfterGettingText", new EventPair("AfterGettingText", "起床后文本"));
    map.put("BeforeGettingText", new EventPair("BeforeGettingText", "在获取文本"));
    map.put("AfterSpeaking", new EventPair("AfterSpeaking", "说到后"));
    map.put("BeforeSpeaking", new EventPair("BeforeSpeaking", "说起前"));
    map.put("MessageReceived", new EventPair("MessageReceived", "收到的消息"));
    map.put("SendMessage", new EventPair("SendMessage", "送信"));
    
    map.put("GotValue", new EventPair("GotValue", "获得值"));
    map.put("ValueStored", new EventPair("ValueStored", "值存储"));
    map.put("DirectMessagesReceived", new EventPair("DirectMessagesReceived", "直接收到消息"));
    map.put("FollowersReceived", new EventPair("FollowersReceived", "收到追随者"));
    map.put("FriendTimelineReceived", new EventPair("FriendTimelineReceived", "朋友时间轴收到的"));
    map.put("IsAuthorized", new EventPair("IsAuthorized", "授权"));
    map.put("MentionsReceived", new EventPair("MentionsReceived", "说起收到"));
    map.put("SearchSuccessful", new EventPair("SearchSuccessful", "搜索成功"));
    map.put("GotBallot", new EventPair("GotBallot", "获取选票"));
    map.put("GotBallotConfirmation", new EventPair("GotBallotConfirmation", "得到选票的确认"));
    map.put("NoOpenPoll", new EventPair("NoOpenPoll", "没有开放投票"));
    map.put("GotFile", new EventPair("GotFile", "获取文件"));
    map.put("GotText", new EventPair("GotText", "获得文本"));
    map.put("LongClick", new EventPair("LongClick", "长按"));
    map.put("Shaking", new EventPair("Shaking", "发抖"));
    map.put("AfterDateSet", new EventPair("AfterDateSet", "日期设置后"));
    map.put("TagRead", new EventPair("TagRead", "读了标签"));
    map.put("TagWritten", new EventPair("TagWritten", "写了标签"));
    map.put("PositionChanged", new EventPair("PositionChanged", "位置变了"));
    map.put("AfterSelecting", new EventPair("AfterSelecting", "选择后"));
    map.put("AfterTimeSet", new EventPair("AfterTimeSet", "时间设置后"));
    map.put("GotTranslation", new EventPair("GotTranslation", "得到了翻译"));
    map.put("Shaking", new EventPair("Shaking", "正在抖"));
