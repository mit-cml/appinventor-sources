...
public class TopToolbar extends Composite {
	private static final String KNOWN_ISSUES_LINK_URL = Ode.APP_INVENTOR_DOCS_URL
			+ "/knownIssues.html";
	private static final String RELEASE_NOTES_LINK_URL = Ode.APP_INVENTOR_DOCS_URL
			+ "/ReleaseNotes.html";
	private static final String KNOWN_ISSUES_LINK_AND_TEXT = "<a href=\""
			+ KNOWN_ISSUES_LINK_URL + "\" target=\"_blank\">known issues</a>";
	private static final String RELEASE_NOTES_LINK_AND_TEXT = "<a href=\""
			+ RELEASE_NOTES_LINK_URL + "\" target=\"_blank\">release notes</a>";
	private static final String termsOfServiceText = "<a href='"
			+ Ode.APP_INVENTOR_DOCS_URL + "/about/termsofservice.html'"
	...
	public TopToolbar() {
		...
		// File -> {New Project; Save; Save As; Checkpoint; |; Delete this
		// Project; My Projects;}
		fileItems.add(new DropDownItem(WIDGET_NAME_MY_PROJECTS, MESSAGES
				.projectMenuItem(), new SwitchToProjectAction()));
		fileItems.add(null);
		fileItems.add(new DropDownItem(WIDGET_NAME_NEW, MESSAGES
				.newProjectMenuItem(), new NewAction()));
		fileItems.add(new DropDownItem(WIDGET_NAME_IMPORTPROJECT, MESSAGES
				.importProjectMenuItem(), new ImportProjectAction()));
		fileItems.add(new DropDownItem(WIDGET_NAME_IMPORTTEMPLATE, MESSAGES
				.importTemplateButton(), new ImportTemplateAction()));
		fileItems.add(new DropDownItem(WIDGET_NAME_DELETE, MESSAGES
				.deleteProjectButton(), new DeleteAction()));
		fileItems.add(null);
		fileItems.add(new DropDownItem(WIDGET_NAME_SAVE, MESSAGES
				.saveMenuItem(), new SaveAction()));
		fileItems.add(new DropDownItem(WIDGET_NAME_SAVE_AS, MESSAGES
				.saveAsMenuItem(), new SaveAsAction()));
		fileItems.add(new DropDownItem(WIDGET_NAME_CHECKPOINT, MESSAGES
				.checkpointMenuItem(), new CheckpointAction()));
		fileItems.add(null);
		...
		fileItems.add(null);
		fileItems.add(new DropDownItem(WIDGET_NAME_UPLOAD_KEYSTORE, MESSAGES
				.uploadKeystoreMenuItem(), new UploadKeystoreAction()));
		fileItems.add(new DropDownItem(WIDGET_NAME_DOWNLOAD_KEYSTORE, MESSAGES
				.downloadKeystoreMenuItem(), new DownloadKeystoreAction()));
		fileItems.add(new DropDownItem(WIDGET_NAME_DELETE_KEYSTORE, MESSAGES
				.deleteKeystoreMenuItem(), new DeleteKeystoreAction()));

		// Connect -> {Connect to Companion; Connect to Emulator; Connect to
		// USB; Reset Connections}
		connectItems.add(new DropDownItem(WIDGET_NAME_WIRELESS_BUTTON, MESSAGES
				.AICompanionMenuItem(), new WirelessAction()));
		connectItems.add(new DropDownItem(WIDGET_NAME_EMULATOR_BUTTON, MESSAGES
				.emulatorMenuItem(), new EmulatorAction()));
		connectItems.add(new DropDownItem(WIDGET_NAME_USB_BUTTON, MESSAGES
				.usbMenuItem(), new UsbAction()));
		connectItems.add(null);
		connectItems.add(new DropDownItem(WIDGET_NAME_RESET_BUTTON, MESSAGES
				.resetConnectionsMenuItem(), new ResetAction()));
		connectItems
				.add(new DropDownItem(WIDGET_NAME_HARDRESET_BUTTON, MESSAGES
						.hardResetConnectionsMenuItem(), new HardResetAction()));

		// Build -> {Show Barcode; Download to Computer; Generate YAIL only when
		// logged in as an admin}
		buildItems.add(new DropDownItem(WIDGET_NAME_BUILD_BARCODE, MESSAGES
				.showBarcodeMenuItem(), new BarcodeAction()));
		buildItems.add(new DropDownItem(WIDGET_NAME_BUILD_DOWNLOAD, MESSAGES
				.downloadToComputerMenuItem(), new DownloadAction()));
		if (AppInventorFeatures.hasYailGenerationOption()
				&& Ode.getInstance().getUser().getIsAdmin()) {
			buildItems.add(null);
			buildItems.add(new DropDownItem(WIDGET_NAME_BUILD_YAIL, MESSAGES
					.generateYailMenuItem(), new GenerateYailAction()));
		}

		// Help -> {About, Library, Get Started, Tutorials, Troubleshooting,
		// Forums, Report an Issue,
		// Companion Information, Show Splash Screen}
		helpItems.add(new DropDownItem(WIDGET_NAME_ABOUT, MESSAGES
				.aboutMenuItem(), new AboutAction()));
		helpItems.add(null);
		helpItems.add(new DropDownItem(WIDGET_NAME_LIBRARY, MESSAGES
				.libraryMenuItem(), new LibraryAction()));
		helpItems.add(new DropDownItem(WIDGET_NAME_GETSTARTED, MESSAGES
				.getStartedMenuItem(), new GetStartedAction()));
		helpItems.add(new DropDownItem(WIDGET_NAME_TUTORIALS, MESSAGES
				.tutorialsMenuItem(), new TutorialsAction()));
		helpItems.add(new DropDownItem(WIDGET_NAME_TROUBLESHOOTING, MESSAGES
				.troubleshootingMenuItem(), new TroubleShootingAction()));
		helpItems.add(new DropDownItem(WIDGET_NAME_FORUMS, MESSAGES
				.forumsMenuItem(), new ForumsAction()));
		helpItems.add(null);
		helpItems.add(new DropDownItem(WIDGET_NAME_FEEDBACK, MESSAGES
				.feedbackMenuItem(), new FeedbackAction()));
		helpItems.add(null);
		helpItems.add(new DropDownItem(WIDGET_NAME_COMPANIONINFO, MESSAGES
				.companionInformation(), new AboutCompanionAction()));
		helpItems.add(new DropDownItem(WIDGET_NAME_SHOWSPLASH, MESSAGES
				.showSplashMenuItem(), new ShowSplashAction()));

		// Create the TopToolbar drop down menus.
		fileDropDown = new DropDownButton(WIDGET_NAME_PROJECT,
				MESSAGES.projectsTabName(), fileItems, false);
		connectDropDown = new DropDownButton(WIDGET_NAME_CONNECT_TO,
				MESSAGES.connectTabName(), connectItems, false);
		buildDropDown = new DropDownButton(WIDGET_NAME_BUILD,
				MESSAGES.buildTabName(), buildItems, false);
		helpDropDown = new DropDownButton(WIDGET_NAME_HELP,
				MESSAGES.helpTabName(), helpItems, false);
		...
		// Commented out language switching until we have a clean Chinese
		// translation. (AFM)
		...
		if (Ode.getInstance().getUser().getIsAdmin()) {
			...
			adminItems.add(new DropDownItem(WIDGET_NAME_DOWNLOAD_USER_SOURCE,
					MESSAGES.downloadUserSourceMenuItem(),
					new DownloadUserSourceAction()));
			adminItems
					.add(new DropDownItem(WIDGET_NAME_SWITCH_TO_DEBUG, MESSAGES
							.switchToDebugMenuItem(), new SwitchToDebugAction()));
			adminDropDown = new DropDownButton(WIDGET_NAME_ADMIN,
					MESSAGES.adminTabName(), adminItems, false);
	...
	private class SaveAction implements Command {
		@Override
		public void execute() {
			ProjectRootNode projectRootNode = Ode.getInstance()
					.getCurrentYoungAndroidProjectRootNode();
			if (projectRootNode != null) {
				ChainableCommand cmd = new SaveAllEditorsCommand(null);
				cmd.startExecuteChain(Tracking.PROJECT_ACTION_SAVE_YA,
						projectRootNode);
			}
		}
	}
	...
	private class SaveAsAction implements Command {
		...
		public void execute() {
			...
			if (projectRootNode != null) {
				...
				cmd.startExecuteChain(Tracking.PROJECT_ACTION_SAVE_AS_YA,
						projectRootNode);
			}
		}
	}
	...
	private class CheckpointAction implements Command {
		...
		public void execute() {
			...
			if (projectRootNode != null) {
				...
				cmd.startExecuteChain(Tracking.PROJECT_ACTION_CHECKPOINT_YA,
						projectRootNode);
			}
		}
	}
	...
	private class ResetAction implements Command {
		...
		public void execute() {
			if (Ode.getInstance().okToConnect()) {
				startRepl(false, false, false); // We are really stopping the
												// repl here
			}
		}
	}
								...
								new BuildCommand(target,
										new ShowProgressBarCommand(target,
												new WaitForBuildResultCommand(
														target,
														new ShowBarcodeCommand(
																target)),
												"BarcodeAction"))));
				// updateBuildButton(true);
				cmd.startExecuteChain(Tracking.PROJECT_ACTION_BUILD_BARCODE_YA,
						projectRootNode, new Command() {
							@Override
							public void execute() {
						...
						new GenerateYailCommand(
								new BuildCommand(
										...
										new ShowProgressBarCommand(
												...
												new WaitForBuildResultCommand(
														target,
														new DownloadProjectOutputCommand(
																target)),
												"DownloadAction"))));
				// updateBuildButton(true);
	...
	private static class ExportProjectAction implements Command {
		@Override
		public void execute() {
			List<Project> selectedProjects = ProjectListBox.getProjectListBox()
	...
	private static class ExportAllProjectsAction implements Command {
		...
		public void execute() {
			...
			// Is there a way to disable the Download All button until this
			// completes?
	...
	private static class DeleteAction implements Command {
		@Override
		public void execute() {
			Ode.getInstance().getEditorManager()
					.saveDirtyEditors(new Command() {
						@Override
						public void execute() {
							if (Ode.getInstance().getCurrentView() == Ode.PROJECTS) {
								List<Project> selectedProjects = ProjectListBox
										.getProjectListBox().getProjectList()
										.getSelectedProjects();
								if (selectedProjects.size() > 0) {
									// Show one confirmation window for selected
									// projects.
									...
									// The user can select a project to resolve
									// the
									// error.
									ErrorReporter.reportInfo(MESSAGES
											.noProjectSelectedForDelete());
								}
							} else { // We are deleting a project in the
										// designer view
								List<Project> selectedProjects = new ArrayList<Project>();
								Project currentProject = Ode
										.getInstance()
										.getProjectManager()
										.getProject(
												Ode.getInstance()
								...
								if (deleteConfirmation(selectedProjects)) {
									...
									// Add the command to stop this current
									// project from saving
									Ode.getInstance().switchToProjectsView();
								}
							}
		...
		private boolean deleteConfirmation(List<Project> projects) {
			String message;
			GallerySettings gallerySettings = GalleryClient.getInstance()
					.getGallerySettings();
			if (projects.size() == 1) {
				if (projects.get(0).isPublished())
					message = MESSAGES
							.confirmDeleteSinglePublishedProject(projects
									.get(0).getProjectName());
				else
					message = MESSAGES.confirmDeleteSingleProject(projects.get(
							0).getProjectName());
			} else {
				...
				if (!gallerySettings.galleryEnabled()) {
					...
					message = MESSAGES
							.confirmDeleteManyProjectsWithGalleryOn(projectNames);
				}
			}
		...
		private void deleteProject(Project project) {
			...
			boolean isCurrentProject = (projectId == ode
					.getCurrentYoungAndroidProjectId());
			ode.getEditorManager().closeProjectEditor(projectId);
			if (isCurrentProject) {
				// If we're deleting the project that is currently open in the
				// Designer we
		...
		private void doDeleteProject(final long projectId) {
			Ode.getInstance().getProjectService()
					.deleteProject(projectId, new OdeAsyncCallback<Void>(
					// failure message
						...
						public void onSuccess(Void result) {
							...
							// projects saved.
							if (Ode.getInstance().getProjectManager()
									.getProjects().size() == 0) {
		...
		private void doDeleteGalleryApp(final long galleryId) {
			Ode.getInstance().getGalleryService()
					.deleteApp(galleryId, new OdeAsyncCallback<Void>(
					// failure message
		...
		public void execute() {
			Ode.getInstance()
					...
					.hasUserFile(
							...
							new OdeAsyncCallback<Boolean>(MESSAGES
								...
								public void onSuccess(Boolean keystoreFileExists) {
									if (keystoreFileExists) {
										Tracking.trackEvent(
												Tracking.USER_EVENT,
												Tracking.USER_ACTION_DOWNLOAD_KEYSTORE);
										Downloader
												.getInstance()
												.download(
														ServerLayout.DOWNLOAD_SERVLET_BASE
																+ ServerLayout.DOWNLOAD_USERFILE
																+ "/"
																+ StorageUtil.ANDROID_KEYSTORE_FILENAME);
									} else {
										Window.alert(MESSAGES
												.noKeystoreToDownload());
									}
								}
							});
		}
			...
			Ode.getInstance()
					...
					.hasUserFile(
							...
							new OdeAsyncCallback<Boolean>(MESSAGES
								...
								public void onSuccess(Boolean keystoreFileExists) {
									if (!keystoreFileExists
											|| Window.confirm(MESSAGES
													.confirmOverwriteKeystore())) {
										KeystoreUploadWizard wizard = new KeystoreUploadWizard(
												new Command() {
													@Override
													public void execute() {
														Tracking.trackEvent(
																Tracking.USER_EVENT,
																Tracking.USER_ACTION_UPLOAD_KEYSTORE);
	...
	private class DeleteKeystoreAction implements Command {
		...
		public void execute() {
			...
			Ode.getInstance()
					.getUserInfoService()
					.hasUserFile(StorageUtil.ANDROID_KEYSTORE_FILENAME,
							new OdeAsyncCallback<Boolean>(errorMessage) {
								@Override
								public void onSuccess(Boolean keystoreFileExists) {
									if (keystoreFileExists
											&& Window.confirm(MESSAGES
													.confirmDeleteKeystore())) {
										Tracking.trackEvent(
												Tracking.USER_EVENT,
												Tracking.USER_ACTION_DELETE_KEYSTORE);
										Ode.getInstance()
												.getUserInfoService()
												.deleteUserFile(
														StorageUtil.ANDROID_KEYSTORE_FILENAME,
	 ...
	 * Implements the action to generate the ".yail" file for each screen in the
	 * current project. It does not build the entire project. The intention is
	 * that this will be helpful for debugging during development, and will most
	 * likely be disabled in the production system.
	 */
	private class GenerateYailAction implements Command {
		...
		public void execute() {
			...
			if (projectRootNode != null) {
				...
				// updateBuildButton(true);
				cmd.startExecuteChain(Tracking.PROJECT_ACTION_BUILD_YAIL_YA,
						projectRootNode, new Command() {
							@Override
							public void execute() {
								// updateBuildButton(false);
	...
	private static class AboutAction implements Command {
		...
		public void execute() {
			...
			HTML message = new HTML(MESSAGES.gitBuildId(GitBuildId.getDate(),
	...
	private static class AboutCompanionAction implements Command {
		...
		public void execute() {
			...
			VerticalPanel DialogBoxContents = new VerticalPanel();
			HTML message = new HTML("Companion Version "
					+ BlocklyPanel.getCompVersion() + downloadinfo);
	...
	private static class GetStartedAction implements Command {
		@Override
		public void execute() {
			Window.open("http://appinventor.mit.edu/explore/get-started",
					"_ai2", "scrollbars=1");
		}
	}
	...
	private static class TutorialsAction implements Command {
		@Override
		public void execute() {
			Window.open("http://appinventor.mit.edu/explore/ai2/tutorials",
					"_ai2", "scrollbars=1");
		}
	}
	...
	private static class TroubleShootingAction implements Command {
		...
		public void execute() {
			Window.open(
					"http://appinventor.mit.edu/explore/ai2/support/troubleshooting",
					"_ai2", "scrollbars=1");
		}
	}
	...
	private static class FeedbackAction implements Command {
		@Override
		public void execute() {
			Window.open("http://something.example.com", "_blank",
					"scrollbars=1");
		}
	}

	private void updateConnectToDropDownButton(boolean isEmulatorRunning,
			boolean isCompanionRunning, boolean isUsbRunning) {
		if (!isEmulatorRunning && !isCompanionRunning && !isUsbRunning) {
			connectDropDown
					.setItemEnabled(MESSAGES.AICompanionMenuItem(), true);
			connectDropDown.setItemEnabled(MESSAGES.emulatorMenuItem(), true);
			connectDropDown.setItemEnabled(MESSAGES.usbMenuItem(), true);
		} else {
			connectDropDown.setItemEnabled(MESSAGES.AICompanionMenuItem(),
					false);
	...
	/**
	 * Indicate that we are no longer connected to the Companion, adjust buttons
	 * accordingly. Called from BlocklyPanel
	 */
	 ...
	 * 
	 * @param start
	 *            -- true to start the repl, false to stop it.
	 * @param forEmulator
	 *            -- true if we are connecting to the emulator.
	 * @param forUsb
	 *            -- true if this is a USB connection.
	 * 
	 *            If both forEmulator and forUsb are false, then we are
	 *            connecting via Wireless.
	 */

	private void startRepl(boolean start, boolean forEmulator, boolean forUsb) {
		DesignToolbar.DesignProject currentProject = Ode.getInstance()
				.getDesignToolbar().getCurrentProject();
		if (currentProject == null) {
			OdeLog.wlog("DesignToolbar.currentProject is null. "
					+ "Ignoring attempt to start the repl.");
			return;
		}
		DesignToolbar.Screen screen = currentProject.screens
				.get(currentProject.currentScreen);
	...
	/**
	 * Enables and/or disables buttons based on how many projects exist (in the
	 * case of "Download All Projects") or are selected (in the case of "Delete"
	 * and "Download Source").
	 */
	public void updateFileMenuButtons(int view) {
		if (view == 0) { // We are in the Projects view
			...
			fileDropDown.setItemEnabled(MESSAGES.deleteProjectMenuItem(), Ode
					.getInstance().getProjectManager().getProjects() == null);
			fileDropDown
					.setItemEnabled(MESSAGES.exportAllProjectsMenuItem(), Ode
							.getInstance().getProjectManager().getProjects()
							.size() > 0);
			fileDropDown
					.setItemEnabled(MESSAGES.exportProjectMenuItem(), false);
			...
			buildDropDown.setItemEnabled(MESSAGES.downloadToComputerMenuItem(),
					false);
	...
	/**
	 * Enables or disables buttons based on whether the user has an
						...
						new AsyncCallback<Boolean>() {
							...
							public void onSuccess(Boolean keystoreFileExists) {
								fileDropDown.setItemEnabled(
										MESSAGES.deleteKeystoreMenuItem(),
										keystoreFileExists);
								fileDropDown.setItemEnabled(
										MESSAGES.downloadKeystoreMenuItem(),
										keystoreFileExists);
							}

							@Override
							public void onFailure(Throwable caught) {
								// Enable the MenuItems. If they are clicked,
								// we'll check again if the keystore exists.
								fileDropDown.setItemEnabled(
										MESSAGES.deleteKeystoreMenuItem(), true);
								fileDropDown.setItemEnabled(
										MESSAGES.downloadKeystoreMenuItem(),
										true);
							}
