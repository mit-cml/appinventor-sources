...
/**
 * Mock for the non-visible Translate component. This needs a separate mock
 ...
 */
public class MockTranslate extends MockNonVisibleComponent {
   ...
   * @param iconImage
   */
  public MockTranslate(SimpleEditor editor, String type, Image iconImage) {
  ...
  private void getTokenFromServer() {
    Ode.getInstance().getTokenAuthService().getTranslateToken(new OdeAsyncCallback<String>() {
      ...
      public void onSuccess(String token) {
        EditableProperty tokenProperty = MockTranslate.this.properties.getProperty(PROPERTY_NAME_APIKEY);
