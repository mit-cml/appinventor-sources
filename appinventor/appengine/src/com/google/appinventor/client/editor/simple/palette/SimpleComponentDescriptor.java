...
import com.google.appinventor.client.editor.simple.components.MockLineChartData;
...
public final class SimpleComponentDescriptor {
  ...
  public static MockComponent createMockComponent(String name, String type, SimpleEditor editor) {
    ...
    } else if (name.equals(MockLineChartData.TYPE)) {
      return new MockLineChartData(editor);
    } else {
