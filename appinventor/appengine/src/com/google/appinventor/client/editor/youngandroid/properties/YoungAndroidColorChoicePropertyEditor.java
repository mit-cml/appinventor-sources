...
public final class YoungAndroidColorChoicePropertyEditor extends ColorChoicePropertyEditor {
  ...
  private static final Color[] YA_COLORS = {
    ...
    new Color(MESSAGES.pinkColor(), Color.ALPHA_OPAQUE, "F294C6"),
    new Color(MESSAGES.redColor(), Color.ALPHA_OPAQUE, "CC2016"),
    new Color(MESSAGES.orangeColor(), Color.ALPHA_OPAQUE, "ED652B"),
    new Color(MESSAGES.yellowColor(), Color.ALPHA_OPAQUE, "FAE333"),
    new Color(MESSAGES.greenColor(), Color.ALPHA_OPAQUE, "5B9C1A"),
    new Color(MESSAGES.cyanColor(), Color.ALPHA_OPAQUE, "4D9AE0"),
    new Color(MESSAGES.blueColor(), Color.ALPHA_OPAQUE, "09239C"),
    new Color(MESSAGES.magentaColor(), Color.ALPHA_OPAQUE, "A22FA6"),
