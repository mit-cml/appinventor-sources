 ...
 * Mock Look component.
 */
public final class MockLook extends MockVisibleComponent {

  /**
   * Component type name.
   */
  public static final String TYPE = "Look";

  // Large icon image for use in designer.  Smaller version is in the palette.
  private final Image largeImage = new Image(images.lookbig());
   ...
   */
  public MockLook(SimpleEditor editor) {
    super(editor, TYPE, images.look());
  ...
  public MockLook(SimpleEditor editor, String type) {
    super(editor, type, images.look());

    // Initialize mock Look UI
    SimplePanel webViewerWidget = new SimplePanel();
    webViewerWidget.setStylePrimaryName("ode-SimpleMockContainer");
    // TODO(halabelson): Center vertically as well as horizontally
    webViewerWidget.addStyleDependentName("centerContents");
