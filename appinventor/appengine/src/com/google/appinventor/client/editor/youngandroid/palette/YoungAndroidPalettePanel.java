...
import com.google.appinventor.client.editor.youngandroid.properties.YoungAndroidLabelFormatChoicePropertyEditor;
...
public class YoungAndroidPalettePanel extends Composite implements SimplePalettePanel {
  ...
  private PropertyEditor createPropertyEditor(String editorType) {
    ...
    } else if (editorType.equals(PropertyTypeConstants.PROPERTY_TYPE_LABEL_FORMAT)) {
      return new YoungAndroidLabelFormatChoicePropertyEditor();
    } else {
