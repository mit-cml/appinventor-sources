...
/**
 * A simple panel that adds the ability to catch mouse and keyboard events.
 * Use instead of FocusPanel.
 */

@SuppressWarnings("deprecation")
public class HandlerPanel extends SimplePanel implements
...
//    super(impl.createFocusable());
  ...
  public HandlerPanel(Widget child) {
    this();
    setWidget(child);
  }
