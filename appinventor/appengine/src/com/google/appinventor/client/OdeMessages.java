...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("Can not Import Project while One project is in import process.")
  @Description("Error message reported when a proejct can't import cause of another one in process")
  String projectImportError();
