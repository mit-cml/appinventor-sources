...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("Horizontal : 0")
  @Description("Sets the orientation of the contents of a ListViewRow as horizontal.")
  String horizontalOrientation();

  @DefaultMessage("Vertical : 1")
  @Description("Sets the orientation of the contents of a ListViewRow as vertical.")
