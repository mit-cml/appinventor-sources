...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @Description("Text on \"Create New Folder\" button")
  String createFolderButton();

  @DefaultMessage("Move to Folder")
  @Description("Text on \"Create New Folder\" button")
  String moveToFolderButton();
  ...
  @DefaultMessage("System error: Could not move project to folder.")
  @Description("Default message for project folder movement errors")
  String couldNotChangeProjectFolder();

  // Used in youngandroid/ProjectList.java

  @DefaultMessage("Parent Folder")
  @Description("The folder containing the current folder. Used similarly to breadcrumb .. in Unix cd.")
  String parentFolderName();

  // Used in boxes/TrashProjectListBox.java

  @DefaultMessage("My Project Trash Can")
  ...
  @DefaultMessage("Are you sure you want to move this folder to trash: {0}?")
  @Description("Confirmation message for selecting a single folder and clicking trash")
  String confirmTrashSingleFolder(String folderName);

  @DefaultMessage("Are you sure you want to move these folders to trash: {0}?")
  @Description("Confirmation message for selecting multiple folders and clicking trash")
  String confirmTrashMultipleFolders(String folderNames);
  ...
  // Used in wizards/NewFolderWizard.java

  @DefaultMessage("Create new App Inventor folder")
  @Description("Caption for the wizard to create a new folder")
  String newFolderWizardCaption();

  @DefaultMessage("Folder name:")
  @Description("Label for the folder name input text box")
  String folderNameLabel();

  @DefaultMessage("Choose a folder")
  @Description("Caption for folder selection wizard")
  String chooseFolderWizardCaption();
  ...
  @DefaultMessage("Folder names must start with a letter and can contain only letters, " +
      "numbers, and underscores")
  @Description("Error message when folder name does not start with a letter or contains a " +
      "character that is not a letter, number, or underscore.")
  String malformedFolderNameError();

  @DefaultMessage("{0} already exists. You cannot create another folder with the same name.")
  @Description("Error shown when a new folder name would be the same as an existing one")
  String duplicateFolderNameError(String folderName);
  ...
  @DefaultMessage("Folder names must begin with a letter")
