...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("Import Screen (.scr) from my computer ...")
  @Description("Name of Import Screen menuitem")
  String importScreenMenuItem();

  @DefaultMessage("Export selected screen (.scr) to my computer")
  ...
  @DefaultMessage("The selected file is not a screen source file!\n" +
                  "Project source files are .scr files.")
  ...
  String AppIdProperties();

  @DefaultMessage("OneSignalPush")
  ...
  @Description("")
  String OneSignalPushHelpStringComponentPallette();
  
  @DefaultMessage("MinAPI")
  @Description("")
  String MinAPIProperties();
}
