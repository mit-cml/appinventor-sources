...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  // Used in
  // editor/youngandroid/properties/YoungAndroidBackgroundImageRepeatModePropertyEditor.java
  @DefaultMessage("None")
  @Description("Choice for background image repeat mode 'none'")
  String backgroundImageRepeatModeNone();

  // Used in
  // editor/youngandroid/properties/YoungAndroidBackgroundImageRepeatModePropertyEditor.java
  @DefaultMessage("Repeat X and Y")
  @Description("Choice for background image repeat mode 'repeat x and y'")
  String backgroundImageRepeatModeXY();
