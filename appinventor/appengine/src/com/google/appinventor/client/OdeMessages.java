...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  //SubsetJSONEditor
  @DefaultMessage("<p>Choose the set of components you’ll need for your project. Simple menus are " + 
  "good for beginner projects, and expert menus are best for building complex apps. For example, the " + 
  "Beginner toolkit gives you access to all the features you need for our novice tutorials and curriculum.</p>" +
  "<p>You can always change the toolkit for your project, so your choice now won’t limit the future possibilities for your app!</p>")
  @Description("")
  String toolkitDescription();
  @DefaultMessage("http://ai2.appinventor.mit.edu/reference/components/userinterface.html#Screen:~:text=increased%20in%20size.-,BlocksToolkit,-A%20JSON%20string")
  @Description("Description Link")
  String toolkitDescriptionLink();
  ...
  @DefaultMessage("<p> Pick a design theme for your app. Themes change the details of an app, " +
  ...
  "Android, iOS, and App Inventor’s designer. See how your design really looks by connecting to your device using the Companion.")
  @Description("")
  String themeDescription();

  @DefaultMessage("http://ai2.appinventor.mit.edu/reference/components/userinterface.html#Screen:~:text=in%20the%20app.-,Theme,-Selects%20the%20theme")
  @Description("Description Link")
  String themeDescriptionLink();
