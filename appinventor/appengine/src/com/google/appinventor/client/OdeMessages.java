...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("My Trash Projects")
  ...
  @Description("Label of the menu item to restore project back from trash")
  String restoreProjectMenuItem();

  @DefaultMessage("Delete Forever")
  @Description("Label of the menu item to delete project forever")
  String deleteForeverProjectMenuItem();
