...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  // Used in editor/simple/components/MockCSVFile.java

  @DefaultMessage("Reading data from {0} to update the columns of {1}.")
  @Description("Message displayed when CSV is being parsed for a CSVFile component.")
  String csvParsingMessage(String filename, String dataFile);

  @DefaultMessage("Empty file specified!")
  @Description("Message displayed when the Source File specified in the CSVFile is an empty file.")
