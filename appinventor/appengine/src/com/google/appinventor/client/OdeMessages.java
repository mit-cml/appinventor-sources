...
public interface OdeMessages extends Messages {
    ...
    // Not used anymore it is now dynamically created and translated at compile time
    // depending on what
    ...
    @DefaultMessage("Select 'tablet' to see Preview on Tablet size.")
    @Description("Listbox (tablet) controlling whether to display a preview on Tablet size.")
    String previewTabletSize();

    @DefaultMessage("Select 'phone' to see Preview on Phone size.")
    @Description("Listbox (phone) controlling whether to display a preview on Phone size.")
    String previewPhoneSize();

    @DefaultMessage("Select 'monitor' to see Preview on Monitor size.")
    @Description("Listkbox (monitor) controlling whether to display a preview on Monitor size.")
    ...
    // Used in settings/CommonSettings.java, settings/project/ProjectSettings.java,
    // and
    ...
    @DefaultMessage("A Component that acts like a Pedometer. It senses motion via the "
            ...
            + "taken. Using a configurable stride length, it can estimate the " + "distance traveled as well. ")
    @Description("")
    ...
    @DefaultMessage("Either your session has expired, or App Inventor has been upgraded. "
            + "You will need to \"Reload\" your session to continue. Press the \"Reload\" Button " + "below.")
    @Description("")
    String sessionDead();
