...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("Rename...")
  @Description("Label for the context menu command that renames a file")
  String renameFileCommand();
  ...
  @DefaultMessage("Current file name exists in project")
  @Description("Error message when file name contains characters that would require URL encoding.")
  ...
  @DefaultMessage("Error: Name already exists !")
  @Description("Rename for asset on DialogBox on Duplicate Name Error")
  String duplicateTitleInAssetRenameError();
