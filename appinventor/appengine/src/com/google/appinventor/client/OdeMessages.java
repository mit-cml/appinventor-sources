...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("ChatBot is an experimental feature " +
    "which may change in the future. It is currently restricted to specific accounts " +
    "because it uses the ChatGPT API which costs us money. If you are interested, look " +
    "for information on our community site (community.appinventor.mit.edu).")
  @Description("")
