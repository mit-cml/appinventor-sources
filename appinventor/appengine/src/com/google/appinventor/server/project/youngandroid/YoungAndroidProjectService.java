...
public final class YoungAndroidProjectService extends CommonProjectService {
   ...
   */
  public static String getProjectSettings(String icon, String vCode, String vName, String useslocation, String theme) {
    ...
    return "{\"" + SettingsConstants.PROJECT_YOUNG_ANDROID_SETTINGS + "\":{" +
        ...
        "\":\"" + useslocation + "\",\"" + SettingsConstants.YOUNG_ANDROID_SETTINGS_THEME +
        "\":\"" + theme + "\"}}";
  }
  ...
  public static String getProjectPropertiesFileContents(String projectName, String qualifiedName,
    String icon, String vcode, String vname, String useslocation, String theme) {
  ...
  public void storeProjectSettings(String userId, long projectId, String projectSettings) {
    ...
    if (!newIcon.equals(oldIcon) || !newVCode.equals(oldVCode) || !newVName.equals(oldVName)
      || !newUsesLocation.equals(oldUsesLocation) || !newTheme.equals(oldTheme)) {
      ...
      String newContent = getProjectPropertiesFileContents(projectName, qualifiedName, newIcon, newVCode, newVName, newUsesLocation, newTheme);
  ...
  public long newProject(String userId, String projectName, NewProjectParameters params) {
    ...
    // Create new project
    return storageIo.createProject(userId, project, getProjectSettings("", "1", "1.0", "false", "Theme"));
  }
  ...
  public long copyProject(String userId, long oldProjectId, String newName) {
    ...
    for (String oldSourceFileName : storageIo.getProjectSourceFiles(userId, oldProjectId)) {
      ...
      if (oldSourceFileName.equals(PROJECT_PROPERTIES_FILE_NAME)) {
        ...
        newContents = getProjectPropertiesFileContents(newName, qualifiedFormName, icon, vcode, vname, useslocation, theme);
      } else {
    ...
    return storageIo.createProject(userId, newProject, getProjectSettings(icon, vcode, vname, useslocation, theme));
  }
