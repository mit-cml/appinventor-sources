...
When creating new screens, choose descriptive PascalCase names that reflect the screen's purpose (e.g. LoginScreen, Settings, PlayerProfile) instead of incremental names like Screen2, Screen3.
