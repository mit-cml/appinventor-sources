...
public interface ComponentService extends RemoteService {
   ...
   * return a component node that can be added to the client
   *
   ...
   * @return a node created from the component
   */
  ComponentNode importComponentToProject(ComponentInfo info, long projectId, String folderPath);
