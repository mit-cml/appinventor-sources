...
public class OdeAuthFilterTest {
  ...
  public void testDoFilterShouldContinueFilterChainIfNotWhitelisted() throws Exception {
    ...
    OdeAuthFilter myAuthFilter = new OdeAuthFilter() {
      @Override
      void setUserFromUserId(String userId, boolean isAdmin, boolean isReadOnly) { localUserMock.set(new User("1", "NonSuch", "NoName", null, 0, false, false, 0, null, null)); return;}
      @Override
      void removeUser() {}
      @Override
