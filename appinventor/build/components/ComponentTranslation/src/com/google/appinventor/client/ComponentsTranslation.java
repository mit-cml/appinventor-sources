...
/* Properties */
    ...
    map.put("PROPERTY-AButton", MESSAGES.AButtonProperties());
    map.put("PROPERTY-BButton", MESSAGES.BButtonProperties());
    ...
    map.put("PROPERTY-LeftJoystickX", MESSAGES.LeftJoystickXProperties());
    map.put("PROPERTY-LeftJoystickY", MESSAGES.LeftJoystickYProperties());
    map.put("PROPERTY-LeftTrigger", MESSAGES.LeftTriggerProperties());
    map.put("PROPERTY-RightBumper", MESSAGES.RightBumperProperties());
    map.put("PROPERTY-RightJoystickX", MESSAGES.RightJoystickXProperties());
    map.put("PROPERTY-RightJoystickY", MESSAGES.RightJoystickYProperties());
    map.put("PROPERTY-RightTrigger", MESSAGES.RightTriggerProperties());
    map.put("PROPERTY-Select", MESSAGES.SelectProperties());
    map.put("PROPERTY-Start", MESSAGES.StartProperties());
    map.put("PROPERTY-XButton", MESSAGES.XButtonProperties());
    map.put("PROPERTY-YButton", MESSAGES.YButtonProperties());
...
/* Methods */
    ...
    map.put("METHOD-DisableGamepad", MESSAGES.DisableGamepadMethods());
    map.put("METHOD-EnableGamepad", MESSAGES.EnableGamepadMethods());
