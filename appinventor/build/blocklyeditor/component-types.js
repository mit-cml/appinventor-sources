var componentTypeJson = [{ "type": "com.google.appinventor.components.runtime.AccelerometerSensor",
  ...
  "external": "false",
  "version": "4",
  "dateBuilt": "2019-11-01T21:20:32+0800",
  ...
  "helpUrl": "Non-visible component that can detect shaking and measure acceleration approximately in three dimensions using SI units (m\/s<sup>2<\/sup>).  The components are: <ul>\n<li> <strong>xAccel<\/strong>: 0 when the phone is at rest on a flat      surface, positive when the phone is tilted to the right (i.e.,      its left side is raised), and negative when the phone is tilted      to the left (i.e., its right size is raised).<\/li>\n <li> <strong>yAccel<\/strong>: 0 when the phone is at rest on a flat      surface, positive when its bottom is raised, and negative when      its top is raised. <\/li>\n <li> <strong>zAccel<\/strong>: Equal to -9.8 (earth's gravity in meters per      second per second when the device is at rest parallel to the ground      with the display facing up,      0 when perpendicular to the ground, and +9.8 when facing down.       The value can also be affected by accelerating it with or against      gravity. <\/li><\/ul>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.Ball",
  ...
  "helpUrl": "<p>A round 'sprite' that can be placed on a <code>Canvas<\/code>, where it can react to touches and drags, interact with other sprites (<code>ImageSprite<\/code>s and other <code>Ball<\/code>s) and the edge of the Canvas, and move according to its property values.<\/p><p>For example, to have a <code>Ball<\/code> move 4 pixels toward the top of a <code>Canvas<\/code> every 500 milliseconds (half second), you would set the <code>Speed<\/code> property to 4 [pixels], the <code>Interval<\/code> property to 500 [milliseconds], the <code>Heading<\/code> property to 90 [degrees], and the <code>Enabled<\/code> property to <code>True<\/code>.  These and its other properties can be changed at any time.<\/p><p>The difference between a Ball and an <code>ImageSprite<\/code> is that the latter can get its appearance from an image file, while a Ball's appearance can only be changed by varying its <code>PaintColor<\/code> and <code>Radius<\/code> properties.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Z", "editorType": "float", "defaultValue": "1.0", "editorArgs": []}],
  "blockProperties": [{ "name": "Enabled", "description": "Controls whether the sprite moves when its speed is non-zero.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "PaintColor", "description": "PaintColor property getter method.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Radius", "description": "", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Speed", "description": "Sets the speed with which this sprite should move.", "type": "number", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.BarcodeScanner",
  ...
  "helpUrl": "Component for using the Barcode Scanner to read a barcode",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.BluetoothClient",
  ...
  "helpUrl": "Bluetooth client component",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.BluetoothServer",
  ...
  "helpUrl": "Bluetooth server component",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/bluetooth.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.Button",
  ...
  "helpUrl": "Button with the ability to detect clicks.  Many aspects of its appearance can be changed, as well as whether it is clickable (<code>Enabled<\/code>), can be changed in the Designer or in the Blocks Editor.",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "Returns the button's background color", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the Button is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.Camcorder",
  ...
  "helpUrl": "A component to record a video using the device's camcorder.After the video is recorded, the name of the file on the phone containing the clip is available as an argument to the AfterRecording event. The file name can be used, for example, to set the source property of a VideoPlayer component.",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.Camera",
  ...
  "helpUrl": "A component to take a picture using the device's camera. After the picture is taken, the name of the file on the phone containing the picture is available as an argument to the AfterPicture event. The file name can be used, for example, to set the Picture property of an Image component.",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.Canvas",
  ...
  "helpUrl": "<p>A two-dimensional touch-sensitive rectangular panel on which drawing can be done and sprites can be moved.<\/p> <p>The <code>BackgroundColor<\/code>, <code>PaintColor<\/code>, <code>BackgroundImage<\/code>, <code>Width<\/code>, and <code>Height<\/code> of the Canvas can be set in either the Designer or in the Blocks Editor.  The <code>Width<\/code> and <code>Height<\/code> are measured in pixels and must be positive.<\/p><p>Any location on the Canvas can be specified as a pair of (X, Y) values, where <ul> <li>X is the number of pixels away from the left edge of the Canvas<\/li><li>Y is the number of pixels away from the top edge of the Canvas<\/li><\/ul>.<\/p> <p>There are events to tell when and where a Canvas has been touched or a <code>Sprite<\/code> (<code>ImageSprite<\/code> or <code>Ball<\/code>) has been dragged.  There are also methods for drawing points, lines, and circles.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "The color of the canvas background.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the Canvas is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.CheckBox",
  ...
  "helpUrl": "Checkbox that raises an event when the user clicks on it. There are many properties affecting its appearance that can be set in the Designer or Blocks Editor.",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "Returns the background color of the CheckBox as an alpha-red-green-blue\n integer.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "FontBold", "description": "Returns true if the text of the CheckBox should be bold.\n If bold has been requested, this property will return true, even if the\n font does not support bold.", "type": "boolean", "rw": "invisible", "deprecated": "false"},
    { "name": "FontItalic", "description": "Returns true if the text of the CheckBox should be italic.\n If italic has been requested, this property will return true, even if the\n font does not support italic.", "type": "boolean", "rw": "invisible", "deprecated": "false"},
    { "name": "FontSize", "description": "Returns the text font size of the CheckBox, measured in sp(scale-independent pixels).", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "FontTypeface", "description": "Returns the text font face of the CheckBox as default, serif, sans\n serif, or monospace.", "type": "number", "rw": "invisible", "deprecated": "false"},
    ...
    { "name": "TextColor", "description": "Returns the text color of the CheckBox as an alpha-red-green-blue\n integer.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Visible", "description": "Returns true iff the CheckBox is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.Clock",
  ...
  "helpUrl": "<p>Non-visible component that provides the instant in time using the internal clock on the phone. It can fire a timer at regularly set intervals and perform time calculations, manipulations, and conversions.<\/p> <p>Methods to convert an instant to text are also available. Acceptable patterns are empty string, MM\/DD\/YYYY HH:mm:ss a, or MMM d, yyyyHH:mm. The empty string will provide the default format, which is \"MMM d, yyyy HH:mm:ss a\" for FormatDateTime \"MMM d, yyyy\" for FormatDate. To see all possible format, please see <a href=\"https:\/\/docs.oracle.com\/javase\/7\/docs\/api\/java\/text\/SimpleDateFormat.html\" _target=\"_blank\">here<\/a>. <\/p> ",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.ContactPicker",
  ...
  "helpUrl": "A button that, when clicked on, displays a list of the contacts to choose among. After the user has made a selection, the following properties will be set to information about the chosen contact: <ul>\n<li> <code>ContactName<\/code>: the contact's name <\/li>\n <li> <code>EmailAddress<\/code>: the contact's primary email address <\/li>\n <li> <code>ContactUri<\/code>: the contact's URI on the device <\/li>\n<li> <code>EmailAddressList<\/code>: a list of the contact's email addresses <\/li>\n <li> <code>PhoneNumber<\/code>: the contact's primary phone number (on Later Android Verisons)<\/li>\n <li> <code>PhoneNumberList<\/code>: a list of the contact's phone numbers (on Later Android Versions)<\/li>\n <li> <code>Picture<\/code>: the name of the file containing the contact's image, which can be used as a <code>Picture<\/code> property value for the <code>Image<\/code> or <code>ImageSprite<\/code> component.<\/li><\/ul>\n<\/p><p>Other properties affect the appearance of the button (<code>TextAlignment<\/code>, <code>BackgroundColor<\/code>, etc.) and whether it can be clicked on (<code>Enabled<\/code>).\n<\/p><p>The ContactPicker component might not work on all phones. For example, on Android systems before system 3.0, it cannot pick phone numbers, and the list of email addresses will contain only one email.",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "Returns the button's background color", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Row", "description": "Row property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "Shape", "description": "Returns the style of the button.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "ShowFeedback", "description": "Specifies if a visual feedback should be shown  for a ContactPicker that as an image as background.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    { "name": "Text", "description": "Text to display on ContactPicker.", "type": "text", "rw": "read-write", "deprecated": "false"},
    { "name": "TextAlignment", "description": "Left, center, or right.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "TextColor", "description": "Color for button text.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Visible", "description": "Returns true iff the ContactPicker is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.DatePicker",
  ...
  "helpUrl": "<p>A button that, when clicked on, launches a popup dialog to allow the user to select a date.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "Returns the button's background color", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Row", "description": "Row property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "Shape", "description": "Returns the style of the button.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "ShowFeedback", "description": "Specifies if a visual feedback should be shown  for a DatePicker that as an image as background.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    { "name": "Text", "description": "Text to display on DatePicker.", "type": "text", "rw": "read-write", "deprecated": "false"},
    { "name": "TextAlignment", "description": "Left, center, or right.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "TextColor", "description": "Color for button text.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Visible", "description": "Returns true iff the DatePicker is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "The background color of the input box.  You can choose a color by name in the Designer or in the Blocks Editor.  The default background color is 'default' (shaded 3-D look).", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Hint", "description": "Text that should appear faintly in the EmailPicker to provide a hint as to what the user should enter.  This can only be seen if the <code>Text<\/code> property is empty.", "type": "text", "rw": "read-write", "deprecated": "false"},
    { "name": "Row", "description": "Row property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the EmailPicker is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
,
    { "name": "LostFocus", "description": "Event raised when the EmailPicker is no longer selected for input, such\n as if the user touches a different text box.", "deprecated": "false", "params": []}
],
...
{ "type": "com.google.appinventor.components.runtime.Ev3ColorSensor",
  ...
  "helpUrl": "A component that provides a high-level interface to a color sensor on a LEGO MINDSTORMS EV3 robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.Ev3Commands",
  ...
  "helpUrl": "A component that provides a low-level interface to a LEGO MINDSTORMS EV3 robot, with functions to send system or direct commands to EV3 robots.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsEv3.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.Ev3GyroSensor",
  ...
  "helpUrl": "A component that provides a high-level interface to a gyro sensor on a LEGO MINDSTORMS EV3 robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsEv3.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.Ev3Motors",
  ...
  "helpUrl": "A component that provides both high- and low-level interfaces to a LEGO MINDSTORMS EV3 robot, with functions that can control the motors.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsEv3.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.Ev3Sound",
  ...
  "helpUrl": "A component that provides a high-level interface to sound functionalities on LEGO MINDSTORMS EV3 robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsEv3.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.Ev3TouchSensor",
  ...
  "helpUrl": "A component that provides a high-level interface to a touch sensor on a LEGO MINDSTORMS EV3 robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsEv3.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.Ev3UI",
  ...
  "helpUrl": "A component that provides a high-level interface to a LEGO MINDSTORMS EV3 robot, with functions to draw graphs on EV3 screen.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsEv3.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.Ev3UltrasonicSensor",
  ...
  "helpUrl": "A component that provides a high-level interface to an ultrasonic sensor on a LEGO MINDSTORMS EV3 robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsEv3.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.FeatureCollection",
  ...
  "helpUrl": "A FeatureColletion contains one or more map features as a group. Any events fired on a feature in the collection will also trigger the corresponding event on the collection object. FeatureCollections can be loaded from external resources as a means of populating a Map with content.",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "Column", "description": "Column property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the FeatureCollection is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.File",
  ...
  "helpUrl": "Non-visible component for storing and retrieving files. Use this component to write or read files on your device. The default behaviour is to write files to the private data directory associated with your App. The Companion is special cased to write files to \/sdcard\/AppInventor\/data to facilitate debugging. If the file path starts with a slash (\/), then the file is created relative to \/sdcard. For example writing a file to \/myFile.txt will write the file in \/sdcard\/myFile.txt.",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.FirebaseDB",
  ...
  "helpUrl": "Non-visible component that communicates with Firebase to store and retrieve information.",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "name": "ProjectBucket", "editorType": "string", "defaultValue": "", "editorArgs": []}],
  "blockProperties": [{ "name": "DefaultURL", "description": "", "type": "text", "rw": "invisible", "deprecated": "false"},
    ...
    { "name": "FirebaseToken", "description": "Getter for the FirebaseToken.", "type": "text", "rw": "invisible", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.Form",
  ...
  "helpUrl": "Top-level component containing all other components in the program",
  "showOnPalette": "false",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "VersionName", "editorType": "string", "defaultValue": "1.0", "editorArgs": []}],
  "blockProperties": [{ "name": "AboutScreen", "description": "Information about the screen.  It appears when \"About this Application\" is selected from the system menu. Use it to inform people about your app.  In multiple screen apps, each screen has its own AboutScreen info.", "type": "text", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "BlocksToolkit", "description": "A JSON string representing the subset for the screen", "type": "text", "rw": "invisible", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.FusiontablesControl",
  ...
  "helpUrl": "<p>A non-visible component that communicates with Google Fusion Tables. Fusion Tables let you store, share, query and visualize data tables; this component lets you query, create, and modify these tables.<\/p> <p>This component uses the <a href=\"https:\/\/developers.google.com\/fusiontables\/docs\/v2\/getting_started\" target=\"_blank\">Fusion Tables API V2.0<\/a>. <p>Applications using Fusion Tables must authentication to Google's servers. There are two ways this can be done. The first way uses an API Key which you the developer obtain (see below). With this approach end-users must also login to access a Fusion Table. The second approach is to use a Service Account. With this approach you create credentials and a special \"Service Account Email Address\" which you obtain from the <a href=\"https:\/\/code.google.com\/apis\/console\/\" target=\"_blank\">Google APIs Console<\/a>. You then tell the Fusion Table Control the name of the Service Account Email address and upload the secret key as an asset to your application and set the KeyFile property to point at this file. Finally you check the \"UseServiceAuthentication\" checkbox in the designer. When using a Service Account, end-users do not need to login to use Fusion Tables, your service account authenticates all access.<\/p> <p>To get an API key, follow these instructions.<\/p> <ol><li>Go to your <a href=\"https:\/\/code.google.com\/apis\/console\/\" target=\"_blank\">Google APIs Console<\/a> and login if necessary.<\/li><li>Select the <i>Services<\/i> item from the menu on the left.<\/li><li>Choose the <i>Fusiontables<\/i> service from the list provided and turn it on.<\/li><li>Go back to the main menu and select the <i>API Access<\/i> item. <\/li><\/ol><p>Your API Key will be near the bottom of that pane in the section called \"Simple API Access\".You will have to provide that key as the value for the <i>ApiKey<\/i> property in your Fusiontables app.<\/p><p>Once you have an API key, set the value of the <i>Query<\/i> property to a valid Fusiontables SQL query and call <i>SendQuery<\/i> to execute the query.  App Inventor will send the query to the Fusion Tables server and the <i>GotResult<\/i> block will fire when a result is returned from the server.Query results will be returned in CSV format, and can be converted to list format using the \"list from csv table\" or \"list from csv row\" blocks.<\/p><p>Note that you do not need to worry about UTF-encoding the query. But you do need to make sure the query follows the syntax described in <a href=\"https:\/\/developers.google.com\/fusiontables\/docs\/v2\/getting_started\" target=\"_blank\">the reference manual<\/a>, which means that things like capitalization for names of columns matters, and that single quotes must be used around column names if there are spaces in them.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.GameClient",
  ...
  "helpUrl": "Provides a way for applications to communicate with online game servers",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.GyroscopeSensor",
  ...
  "helpUrl": "<p>Non-visible component that can measure angular velocity in three dimensions in units of degrees per second.<\/p><p>In order to function, the component must have its <code>Enabled<\/code> property set to True, and the device must have a gyroscope sensor.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.HorizontalArrangement",
  ...
  "helpUrl": "<p>A formatting element in which to place components that should be displayed from left to right.  If you wish to have components displayed one over another, use <code>VerticalArrangement<\/code> instead.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "AlignHorizontal", "description": "A number that encodes how contents of the HorizontalArrangement are aligned  horizontally. The choices are: 1 = left aligned, 2 = right aligned,  3 = horizontally centered.  Alignment has no effect if the arrangement's width is automatic.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Row", "description": "Row property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "Visible", "description": "Returns true iff the HorizontalArrangement is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.HorizontalScrollArrangement",
  ...
  "helpUrl": "<p>A formatting element in which to place components that should be displayed from left to right.  If you wish to have components displayed one over another, use <code>VerticalArrangement<\/code> instead.<\/p><p>This version is scrollable.",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "AlignHorizontal", "description": "A number that encodes how contents of the HorizontalScrollArrangement are aligned  horizontally. The choices are: 1 = left aligned, 2 = right aligned,  3 = horizontally centered.  Alignment has no effect if the arrangement's width is automatic.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Row", "description": "Row property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "Visible", "description": "Returns true iff the HorizontalScrollArrangement is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.Image",
  ...
  "helpUrl": "Component for displaying images.  The picture to display, and other aspects of the Image's appearance, can be specified in the Designer or in the Blocks Editor.",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "Animation", "description": "This is a limited form of animation that can attach a small number of motion types to images.  The allowable motions are ScrollRightSlow, ScrollRight, ScrollRightFast, ScrollLeftSlow, ScrollLeft, ScrollLeftFast, and Stop", "type": "text", "rw": "write-only", "deprecated": "false"},
    ...
    { "name": "RotationAngle", "description": "Specifies the angle at which the image picture appears rotated.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Row", "description": "Row property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the Image is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.ImagePicker",
  ...
  "helpUrl": "A special-purpose button. When the user taps an image picker, the device's image gallery appears, and the user can choose an image. After an image is picked, it is saved, and the <code>Selected<\/code> property will be the name of the file where the image is stored. In order to not fill up storage, a maximum of 10 images will be stored.  Picking more images will delete previous images, in order from oldest to newest.",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "Returns the button's background color", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Shape", "description": "Returns the style of the button.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "ShowFeedback", "description": "Specifies if a visual feedback should be shown  for a ImagePicker that as an image as background.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    { "name": "Text", "description": "Text to display on ImagePicker.", "type": "text", "rw": "read-write", "deprecated": "false"},
    { "name": "TextAlignment", "description": "Left, center, or right.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "TextColor", "description": "Color for button text.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Visible", "description": "Returns true iff the ImagePicker is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
  ...
  "events": [{ "name": "AfterPicking", "description": "Event to be raised after the picker activity returns its\n result and the properties have been filled in.", "deprecated": "false", "params": []}
,
    { "name": "BeforePicking", "description": "Event to raise when the ImagePicker is clicked or the list is shown\n using the Open block.  This event occurs before the list of items is displayed, and \n can be used to prepare the list before it is shown.", "deprecated": "false", "params": []}
,
...
{ "type": "com.google.appinventor.components.runtime.ImageSprite",
  ...
  "helpUrl": "<p>A 'sprite' that can be placed on a <code>Canvas<\/code>, where it can react to touches and drags, interact with other sprites (<code>Ball<\/code>s and other <code>ImageSprite<\/code>s) and the edge of the Canvas, and move according to its property values.  Its appearance is that of the image specified in its <code>Picture<\/code> property (unless its <code>Visible<\/code> property is <code>False<\/code>.<\/p> <p>To have an <code>ImageSprite<\/code> move 10 pixels to the left every 1000 milliseconds (one second), for example, you would set the <code>Speed<\/code> property to 10 [pixels], the <code>Interval<\/code> property to 1000 [milliseconds], the <code>Heading<\/code> property to 180 [degrees], and the <code>Enabled<\/code> property to <code>True<\/code>.  A sprite whose <code>Rotates<\/code> property is <code>True<\/code> will rotate its image as the sprite's <code>Heading<\/code> changes.  Checking for collisions with a rotated sprite currently checks the sprite's unrotated position so that collision checking will be inaccurate for tall narrow or short wide sprites that are rotated.  Any of the sprite properties can be changed at any time under program control.<\/p> ",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Z", "editorType": "float", "defaultValue": "1.0", "editorArgs": []}],
  "blockProperties": [{ "name": "Enabled", "description": "Controls whether the sprite moves when its speed is non-zero.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    { "name": "Heading", "description": "Sets heading in which sprite should move.  In addition to changing the\n local variables", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Height", "description": "Height property getter method.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Interval", "description": "The interval in milliseconds at which the sprite's position is updated.  For example, if the interval is 50 and the speed is 10, then the sprite will move 10 pixels every 50 milliseconds.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Speed", "description": "Sets the speed with which this sprite should move.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Visible", "description": "True if the sprite is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    { "name": "Width", "description": "Width property getter method.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "X", "description": "The horizontal coordinate of the left edge of the sprite, increasing as the sprite moves to the right.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Y", "description": "The vertical coordinate of the top of the sprite, increasing as the sprite moves down.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Z", "description": "Sets the layer of the sprite, indicating whether it will appear in\n front of or behind other sprites.", "type": "number", "rw": "read-write", "deprecated": "false"}],
  "events": [{ "name": "CollidedWith", "description": "Handler for CollidedWith events, called when two sprites collide.\n Note that checking for collisions with a rotated ImageSprite currently\n checks against the sprite's unrotated position.  Therefore, collision\n checking will be inaccurate for tall narrow or short wide sprites that are\n rotated.", "deprecated": "false", "params": [{ "name": "other", "type": "component"}]}
...
{ "type": "com.google.appinventor.components.runtime.Label",
  ...
  "helpUrl": "A Label displays a piece of text, which is specified through the <code>Text<\/code> property.  Other properties, all of which can be set in the Designer or Blocks Editor, control the appearance and placement of the text.",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "Returns the label's background color as an alpha-red-green-blue\n integer.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the Label is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "Description", "description": "The description displayed in the info window that appears when the user clicks on the LineString.", "type": "text", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "StrokeWidth", "description": "The width of the stroke used to outline the LineString.", "type": "number", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.ListPicker",
  ...
  "helpUrl": "<p>A button that, when clicked on, displays a list of texts for the user to choose among. The texts can be specified through the Designer or Blocks Editor by setting the <code>ElementsFromString<\/code> property to their string-separated concatenation (for example, <em>choice 1, choice 2, choice 3<\/em>) or by setting the <code>Elements<\/code> property to a List in the Blocks editor.<\/p><p>Setting property ShowFilterBar to true, will make the list searchable.  Other properties affect the appearance of the button (<code>TextAlignment<\/code>, <code>BackgroundColor<\/code>, etc.) and whether it can be clicked on (<code>Enabled<\/code>).<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "Returns the button's background color", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Shape", "description": "Returns the style of the button.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "ShowFeedback", "description": "Specifies if a visual feedback should be shown  for a ListPicker that as an image as background.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the ListPicker is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
  ...
  "events": [{ "name": "AfterPicking", "description": "Event to be raised after the picker activity returns its\n result and the properties have been filled in.", "deprecated": "false", "params": []}
,
    { "name": "BeforePicking", "description": "Event to raise when the ListPicker is clicked or the list is shown\n using the Open block.  This event occurs before the list of items is displayed, and \n can be used to prepare the list before it is shown.", "deprecated": "false", "params": []}
,
...
{ "type": "com.google.appinventor.components.runtime.ListView",
  ...
  "helpUrl": "<p>This is a visible component that displays a list of text elements. <br> The list can be set using the ElementsFromString property or using the Elements block in the blocks editor. <\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "The color of the listview background.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the ListView is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.LocationSensor",
  ...
  "helpUrl": "Non-visible component providing location information, including longitude, latitude, altitude (if supported by the device), speed (if supported by the device), and address.  This can also perform \"geocoding\", converting a given address (not necessarily the current one) to a latitude (with the <code>LatitudeFromAddress<\/code> method) and a longitude (with the <code>LongitudeFromAddress<\/code> method).<\/p>\n<p>In order to function, the component must have its <code>Enabled<\/code> property set to True, and the device must have location sensing enabled through wireless networks or GPS satellites (if outdoors).<\/p>\nLocation information might not be immediately available when an app starts.  You'll have to wait a short time for a location provider to be found and used, or wait for the OnLocationChanged event",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.Map",
  ...
  "helpUrl": "<p>A two-dimensional container that renders map tiles in the background and allows for multiple Marker elements to identify points on the map. Map tiles are supplied by OpenStreetMap contributors and the United States Geological Survey.<\/p><p>The Map component provides three utilities for manipulating its boundaries within App Inventor. First, a locking mechanism is provided to allow the map to be moved relative to other components on the Screen. Second, when unlocked, the user can pan the Map to any location. At this new location, the &quot;Set Initial Boundary&quot; button can be pressed to save the current Map coordinates to its properties. Lastly, if the Map is moved to a different location, for example to add Markers off-screen, then the &quot;Reset Map to Initial Bounds&quot; button can be used to re-center the Map at the starting location.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 8,
...
{ "name": "ZoomLevel", "editorType": "map_zoom", "defaultValue": "13", "editorArgs": []}],
  "blockProperties": [{ "name": "BoundingBox", "description": "Bounding box for the map stored as [[North, West], [South, East]].", "type": "list", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the Map is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.Marker",
  ...
  "helpUrl": "<p>An icon positioned at a point to indicate information on a map. Markers can be used to provide an info window, custom fill and stroke colors, and custom images to convey information to the user.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.MediaStore",
  ...
  "helpUrl": "Non-visible component that communicates with a Web service and stores media files.",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.NearField",
  ...
  "helpUrl": "<p>Non-visible component to provide NFC capabilities.  For now this component supports the reading and writing of text tags only (if supported by the device)<\/p><p>In order to read and write text tags, the component must have its <code>ReadMode<\/code> property set to True or False respectively.<\/p><p><strong>Note:<\/strong> This component will only work on Screen1 of any App Inventor app.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.Notifier",
  ...
  "helpUrl": "The Notifier component displays alert dialogs, messages, and temporary alerts, and creates Android log entries through the following methods: <ul><li> ShowMessageDialog: displays a message which the user must dismiss by pressing a button.<\/li><li> ShowChooseDialog: displays a message two buttons to let the user choose one of two responses, for example, yes or no, after which the AfterChoosing event is raised.<\/li><li> ShowTextDialog: lets the user enter text in response to the message, after which the AfterTextInput event is raised. <li> ShowPasswordDialog: lets the user enter password in response to the message, after which the AfterTextInput event is raised. <li> ShowAlert: displays a temporary  alert that goes away by itself after a short time.<\/li><li> ShowProgressDialog: displays an alert with a loading spinner that cannot be dismissed by the user. It can only be dismissed by using the DismissProgressDialog block.<\/li><li> DismissProgressDialog: Dismisses the progress dialog displayed by ShowProgressDialog.<\/li><li> LogError: logs an error message to the Android log. <\/li><li> LogInfo: logs an info message to the Android log.<\/li><li> LogWarning: logs a warning message to the Android log.<\/li><li>The messages in the dialogs (but not the alert) can be formatted using the following HTML tags:&lt;b&gt;, &lt;big&gt;, &lt;blockquote&gt;, &lt;br&gt;, &lt;cite&gt;, &lt;dfn&gt;, &lt;div&gt;, &lt;em&gt;, &lt;small&gt;, &lt;strong&gt;, &lt;sub&gt;, &lt;sup&gt;, &lt;tt&gt;. &lt;u&gt;<\/li><li>You can also use the font tag to specify color, for example, &lt;font color=\"blue\"&gt;.  Some of the available color names are aqua, black, blue, fuchsia, green, grey, lime, maroon, navy, olive, purple, red, silver, teal, white, and yellow<\/li><\/ul>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.NxtColorSensor",
  ...
  "helpUrl": "A component that provides a high-level interface to a color sensor on a LEGO MINDSTORMS NXT robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.NxtDirectCommands",
  ...
  "helpUrl": "A component that provides a low-level interface to a LEGO MINDSTORMS NXT robot, with functions to send NXT Direct Commands.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsNxt.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.NxtDrive",
  ...
  "helpUrl": "A component that provides a high-level interface to a LEGO MINDSTORMS NXT robot, with functions that can move and turn the robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsNxt.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.NxtLightSensor",
  ...
  "helpUrl": "A component that provides a high-level interface to a light sensor on a LEGO MINDSTORMS NXT robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsNxt.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.NxtSoundSensor",
  ...
  "helpUrl": "A component that provides a high-level interface to a sound sensor on a LEGO MINDSTORMS NXT robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsNxt.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.NxtTouchSensor",
  ...
  "helpUrl": "A component that provides a high-level interface to a touch sensor on a LEGO MINDSTORMS NXT robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsNxt.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.NxtUltrasonicSensor",
  ...
  "helpUrl": "A component that provides a high-level interface to an ultrasonic sensor on a LEGO MINDSTORMS NXT robot.",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/legoMindstormsNxt.png",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.OrientationSensor",
  ...
  "helpUrl": "<p>Non-visible component providing information about the device's physical orientation in three dimensions: <ul> <li> <strong>Roll<\/strong>: 0 degrees when the device is level, increases to      90 degrees as the device is tilted up on its left side, and      decreases to -90 degrees when the device is tilted up on its right side.      <\/li> <li> <strong>Pitch<\/strong>: 0 degrees when the device is level, up to      90 degrees as the device is tilted so its top is pointing down,      up to 180 degrees as it gets turned over.  Similarly, as the device      is tilted so its bottom points down, pitch decreases to -90      degrees, then further decreases to -180 degrees as it gets turned all the way      over.<\/li> <li> <strong>Azimuth<\/strong>: 0 degrees when the top of the device is      pointing north, 90 degrees when it is pointing east, 180 degrees      when it is pointing south, 270 degrees when it is pointing west,      etc.<\/li><\/ul>     These measurements assume that the device itself is not moving.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.PasswordTextBox",
  ...
  "helpUrl": "<p>A box for entering passwords.  This is the same as the ordinary <code>TextBox<\/code> component except this does not display the characters typed by the user.<\/p><p>The value of the text in the box can be found or set through the <code>Text<\/code> property. If blank, the <code>Hint<\/code> property, which appears as faint text in the box, can provide the user with guidance as to what to type.<\/p> <p>Text boxes are usually used with the <code>Button<\/code> component, with the user clicking on the button when text entry is complete.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "The background color of the input box.  You can choose a color by name in the Designer or in the Blocks Editor.  The default background color is 'default' (shaded 3-D look).", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Hint", "description": "Text that should appear faintly in the PasswordTextBox to provide a hint as to what the user should enter.  This can only be seen if the <code>Text<\/code> property is empty.", "type": "text", "rw": "read-write", "deprecated": "false"},
    { "name": "PasswordVisible", "description": "Visibility of password.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    { "name": "Row", "description": "Row property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "Text", "description": "Returns the textbox contents.", "type": "text", "rw": "read-write", "deprecated": "false"},
    { "name": "TextAlignment", "description": "Whether the text should be left justified, centered, or right justified.  By default, text is left justified.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "TextColor", "description": "The color for the text.  You can choose a color by name in the Designer or in the Blocks Editor.  The default text color is black.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Visible", "description": "Returns true iff the PasswordTextBox is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
  ...
  "events": [{ "name": "GotFocus", "description": "Event raised when the PasswordTextBox is selected for input, such as by\n the user touching it.", "deprecated": "false", "params": []}
,
    { "name": "LostFocus", "description": "Event raised when the PasswordTextBox is no longer selected for input, such\n as if the user touches a different text box.", "deprecated": "false", "params": []}
],
...
{ "type": "com.google.appinventor.components.runtime.Pedometer",
  ...
  "helpUrl": "A Component that acts like a Pedometer. It senses motion via the Accerleromter and attempts to determine if a step has been taken. Using a configurable stride length, it can estimate the distance traveled as well. ",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.PhoneCall",
  ...
  "helpUrl": "<p>A non-visible component that makes a phone call to the number specified in the <code>PhoneNumber<\/code> property, which can be set either in the Designer or Blocks Editor. The component has a <code>MakePhoneCall<\/code> method, enabling the program to launch a phone call.<\/p><p>Often, this component is used with the <code>ContactPicker<\/code> component, which lets the user select a contact from the ones stored on the phone and sets the <code>PhoneNumber<\/code> property to the contact's phone number.<\/p><p>To directly specify the phone number (e.g., 650-555-1212), set the <code>PhoneNumber<\/code> property to a Text with the specified digits (e.g., \"6505551212\").  Dashes, dots, and parentheses may be included (e.g., \"(650)-555-1212\") but will be ignored; spaces may not be included.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
,
  ...
  "methods": [{ "name": "MakePhoneCall", "description": "Makes a phone call using the number in the PhoneNumber property.", "deprecated": "false", "params": []},
    { "name": "MakePhoneCallDirect", "description": "Makes a phone call using the number in the PhoneNumber property.", "deprecated": "false", "params": []}]}
,
{ "type": "com.google.appinventor.components.runtime.PhoneNumberPicker",
  ...
  "helpUrl": "A button that, when clicked on, displays a list of the contacts' phone numbers to choose among. After the user has made a selection, the following properties will be set to information about the chosen contact: <ul>\n<li> <code>ContactName<\/code>: the contact's name <\/li>\n <li> <code>PhoneNumber<\/code>: the contact's phone number <\/li>\n <li> <code>EmailAddress<\/code>: the contact's email address <\/li> <li> <code>Picture<\/code>: the name of the file containing the contact's image, which can be used as a <code>Picture<\/code> property value for the <code>Image<\/code> or <code>ImageSprite<\/code> component.<\/li><\/ul>\n<\/p><p>Other properties affect the appearance of the button (<code>TextAlignment<\/code>, <code>BackgroundColor<\/code>, etc.) and whether it can be clicked on (<code>Enabled<\/code>).<\/p>\n<p>The PhoneNumberPicker component may not work on all Android devices. For example, on Android systems before system 3.0, the returned lists of phone numbers and email addresses will be empty.\n",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "type": "com.google.appinventor.components.runtime.PhoneStatus",
  ...
  "helpUrl": "Component that returns information about the phone.",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.ProximitySensor",
  ...
  "helpUrl": "<p>Non-visible component that can measures the proximity of an object in cm relative to the view screen of a device. This sensor is typically used to determine whether a handset is being held up to a persons ear; i.e. lets you determine how far away an object is from a device. Many devices return the absolute distance, in cm, but some return only near and far values. In this case, the sensor usually reports its maximum range value in the far state and a lesser value in the near state.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.Sharing",
  ...
  "helpUrl": "Sharing is a non-visible component that enables sharing files and\/or messages between your app and other apps installed on a device. The component will display a list of the installed apps that can handle the information provided, and will allow the user to choose one to share the content with, for instance a mail app, a social network app, a texting app, and so on.<br>The file path can be taken directly from other components such as the Camera or the ImagePicker, but can also be specified directly to read from storage. Be aware that different devices treat storage differently, so a few things to try if, for instance, you have a file called arrow.gif in the folder <code>Appinventor\/assets<\/code>, would be: <ul><li><code>\"file:\/\/\/sdcard\/Appinventor\/assets\/arrow.gif\"<\/code><\/li> or <li><code>\"\/storage\/Appinventor\/assets\/arrow.gif\"<\/code><\/li><\/ul>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "ColorLeft", "description": "The color of slider to the left of the thumb.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the Slider is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.SoundRecorder",
  ...
  "helpUrl": "<p>Multimedia component that records audio.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.SpeechRecognizer",
  ...
  "helpUrl": "Component for using Voice Recognition to convert from speech to text",
  "showOnPalette": "true",
  "nonVisible": "true",
  ...
  "events": [{ "name": "AfterGettingText", "description": "Simple event to raise after the VoiceReco activity has returned.\n Partial is 'false' when SpeechRecognizer stops automatically after listening,\n else it is 'true' if SpeechRecognizer returns partial results.", "deprecated": "false", "params": [{ "name": "result", "type": "text"},{ "name": "partial", "type": "boolean"}]}
,
...
{ "type": "com.google.appinventor.components.runtime.Spinner",
  ...
  "helpUrl": "<p>A spinner component that displays a pop-up with a list of elements. These elements can be set in the Designer or Blocks Editor by setting the<code>ElementsFromString<\/code> property to a string-separated concatenation (for example, <em>choice 1, choice 2, choice 3<\/em>) or by setting the <code>Elements<\/code> property to a List in the Blocks editor. Spinners are created with the first item already selected. So selecting  it does not generate an After Picking event. Consequently it's useful to make the  first Spinner item be a non-choice like \"Select from below...\". <\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "Column", "description": "Column property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the Spinner is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.Switch",
  ...
  "helpUrl": "Toggle switch that raises an event when the user clicks on it. There are many properties affecting its appearance that can be set in the Designer or Blocks Editor.",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "Returns the background color of the Switch as an alpha-red-green-blue\n integer.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Column", "description": "Column property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "Enabled", "description": "Returns true if the Switch is active and clickable.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    { "name": "FontBold", "description": "Returns true if the text of the Switch should be bold.\n If bold has been requested, this property will return true, even if the\n font does not support bold.", "type": "boolean", "rw": "invisible", "deprecated": "false"},
    { "name": "FontItalic", "description": "Returns true if the text of the Switch should be italic.\n If italic has been requested, this property will return true, even if the\n font does not support italic.", "type": "boolean", "rw": "invisible", "deprecated": "false"},
    { "name": "FontSize", "description": "Returns the text font size of the Switch, measured in sp(scale-independent pixels).", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "FontTypeface", "description": "Returns the text font face of the Switch as default, serif, sans\n serif, or monospace.", "type": "number", "rw": "invisible", "deprecated": "false"},
    ...
    { "name": "On", "description": "Returns true if the checkbox is checked.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    { "name": "Row", "description": "Row property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "Text", "description": "Returns the text displayed by the Switch.", "type": "text", "rw": "read-write", "deprecated": "false"},
    { "name": "TextColor", "description": "Returns the text color of the Switch as an alpha-red-green-blue\n integer.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "ThumbColorActive", "description": "Returns the switch's thumb color (button that toggles back and forth)\n when the switch is ON\/Checked", "type": "number", "rw": "invisible", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the Switch is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.TableArrangement",
  ...
  "helpUrl": "<p>A formatting element in which to place components that should be displayed in tabular form.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "Column", "description": "Column property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the TableArrangement is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.TextBox",
  ...
  "helpUrl": "<p>A box for the user to enter text.  The initial or user-entered text value is in the <code>Text<\/code> property.  If blank, the <code>Hint<\/code> property, which appears as faint text in the box, can provide the user with guidance as to what to type.<\/p><p>The <code>MultiLine<\/code> property determines if the text can havemore than one line.  For a single line text box, the keyboard will closeautomatically when the user presses the Done key.  To close the keyboard for multiline text boxes, the app should use  the HideKeyboard method or  rely on the user to press the Back key.<\/p><p>The <code> NumbersOnly<\/code> property restricts the keyboard to acceptnumeric input only.<\/p><p>Other properties affect the appearance of the text box (<code>TextAlignment<\/code>, <code>BackgroundColor<\/code>, etc.) and whether it can be used (<code>Enabled<\/code>).<\/p><p>Text boxes are usually used with the <code>Button<\/code> component, with the user clicking on the button when text entry is complete.<\/p><p>If the text entered by the user should not be displayed, use <code>PasswordTextBox<\/code> instead.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "The background color of the input box.  You can choose a color by name in the Designer or in the Blocks Editor.  The default background color is 'default' (shaded 3-D look).", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Hint", "description": "Text that should appear faintly in the TextBox to provide a hint as to what the user should enter.  This can only be seen if the <code>Text<\/code> property is empty.", "type": "text", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "TextAlignment", "description": "Whether the text should be left justified, centered, or right justified.  By default, text is left justified.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "TextColor", "description": "The color for the text.  You can choose a color by name in the Designer or in the Blocks Editor.  The default text color is black.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Visible", "description": "Returns true iff the TextBox is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
  ...
  "events": [{ "name": "GotFocus", "description": "Event raised when the TextBox is selected for input, such as by\n the user touching it.", "deprecated": "false", "params": []}
,
    { "name": "LostFocus", "description": "Event raised when the TextBox is no longer selected for input, such\n as if the user touches a different text box.", "deprecated": "false", "params": []}
],
...
{ "type": "com.google.appinventor.components.runtime.TextToSpeech",
  ...
  "helpUrl": "The TestToSpeech component speaks a given text aloud.  You can set the pitch and the rate of speech. <p>You can also set a language by supplying a language code.  This changes the pronounciation of words, not the actual language spoken.  For example, setting the language to French and speaking English text will sound like someone speaking English (en) with a French accent.<\/p> <p>You can also specify a country by supplying a country code. This can affect the pronounciation.  For example, British English (GBR) will sound different from US English (USA).  Not every country code will affect every language.<\/p> <p>The languages and countries available depend on the particular device, and can be listed with the AvailableLanguages and AvailableCountries properties.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.Texting",
  ...
  "helpUrl": "<p>A component that will, when the <code>SendMessage<\/code> method is called, send the text message specified in the <code>Message<\/code> property to the phone number specified in the <code>PhoneNumber<\/code> property.<\/p> <p>If the <code>ReceivingEnabled<\/code> property is set to 1 messages will <b>not<\/b> be received. If <code>ReceivingEnabled<\/code> is set to 2 messages will be received only when the application is running. Finally if <code>ReceivingEnabled<\/code> is set to 3, messages will be received when the application is running <b>and<\/b> when the application is not running they will be queued and a notification displayed to the user.<\/p> <p>When a message arrives, the <code>MessageReceived<\/code> event is raised and provides the sending number and message.<\/p> <p> An app that includes this component will receive messages even when it is in the background (i.e. when it's not visible on the screen) and, moreso, even if the app is not running, so long as it's installed on the phone. If the phone receives a text message when the app is not in the foreground, the phone will show a notification in the notification bar.  Selecting the notification will bring up the app.  As an app developer, you'll probably want to give your users the ability to control ReceivingEnabled so that they can make the phone ignore text messages.<\/p> <p>If the GoogleVoiceEnabled property is true, messages can be sent over Wifi using Google Voice. This option requires that the user have a Google Voice account and that the mobile Voice app is installed on the phone. The Google Voice option works only on phones that support Android 2.0 (Eclair) or higher.<\/p> <p>To specify the phone number (e.g., 650-555-1212), set the <code>PhoneNumber<\/code> property to a Text string with the specified digits (e.g., 6505551212).  Dashes, dots, and parentheses may be included (e.g., (650)-555-1212) but will be ignored; spaces may not be included.<\/p> <p>Another way for an app to specify a phone number would be to include a <code>PhoneNumberPicker<\/code> component, which lets the users select a phone numbers from the ones stored in the the phone's contacts.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "name": "ReceivingEnabled", "editorType": "text_receiving", "defaultValue": "1", "editorArgs": [], "alwaysSend": true}],
  ...
  "methods": [{ "name": "SendMessage", "description": "Send a text message", "deprecated": "false", "params": []},
    { "name": "SendMessageDirect", "description": "Send a text message directly", "deprecated": "false", "params": []}]}
,
{ "type": "com.google.appinventor.components.runtime.TimePicker",
  ...
  "helpUrl": "<p>A button that, when clicked on, launches  a popup dialog to allow the user to select a time.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "Returns the button's background color", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Row", "description": "Row property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "Shape", "description": "Returns the style of the button.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "ShowFeedback", "description": "Specifies if a visual feedback should be shown  for a TimePicker that as an image as background.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    { "name": "Text", "description": "Text to display on TimePicker.", "type": "text", "rw": "read-write", "deprecated": "false"},
    { "name": "TextAlignment", "description": "Left, center, or right.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "TextColor", "description": "Color for button text.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Visible", "description": "Returns true iff the TimePicker is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.TinyDB",
  ...
  "helpUrl": "TinyDB is a non-visible component that stores data for an app. <p> Apps created with App Inventor are initialized each time they run: If an app sets the value of a variable and the user then quits the app, the value of that variable will not be remembered the next time the app is run. In contrast, TinyDB is a <em> persistent <\/em> data store for the app, that is, the data stored there will be available each time the app is run. An example might be a game that saves the high score and retrieves it each time the game is played. <\/<p> <p> Data items are strings stored under <em>tags<\/em> . To store a data item, you specify the tag it should be stored under.  Subsequently, you can retrieve the data that was stored under a given tag. <\/p><p> There is only one data store per app. Even if you have multiple TinyDB components, they will use the same data store. To get the effect of separate stores, use different keys. Also each app has its own data store. You cannot use TinyDB to pass data between two different apps on the phone, although you <em>can<\/em> use TinyDb to shares data between the different screens of a multi-screen app. <\/p> <p>When you are developing apps using the AI Companion, all the apps using that companion will share the same TinyDb.  That sharing will disappear once the apps are packaged.  But, during development, you should be careful to clear the TinyDb each time you start working on a new app.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.TinyWebDB",
  ...
  "helpUrl": "Non-visible component that communicates with a Web service to store and retrieve information.",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.Twitter",
  ...
  "helpUrl": "A non-visible component that enables communication with <a href=\"http:\/\/www.twitter.com\" target=\"_blank\">Twitter<\/a>. Once a user has logged into their Twitter account (and the authorization has been confirmed successful by the <code>IsAuthorized<\/code> event), many more operations are available:<ul><li> Searching Twitter for tweets or labels (<code>SearchTwitter<\/code>)<\/li>\n<li> Sending a Tweet (<code>Tweet<\/code>)     <\/li>\n<li> Sending a Tweet with an Image (<code>TweetWithImage<\/code>)     <\/li>\n<li> Directing a message to a specific user      (<code>DirectMessage<\/code>)<\/li>\n <li> Receiving the most recent messages directed to the logged-in user      (<code>RequestDirectMessages<\/code>)<\/li>\n <li> Following a specific user (<code>Follow<\/code>)<\/li>\n<li> Ceasing to follow a specific user (<code>StopFollowing<\/code>)<\/li>\n<li> Getting a list of users following the logged-in user      (<code>RequestFollowers<\/code>)<\/li>\n <li> Getting the most recent messages of users followed by the      logged-in user (<code>RequestFriendTimeline<\/code>)<\/li>\n <li> Getting the most recent mentions of the logged-in user      (<code>RequestMentions<\/code>)<\/li><\/ul><\/p>\n <p>You must obtain a Consumer Key and Consumer Secret for Twitter authorization  specific to your app from http:\/\/twitter.com\/oauth_clients\/new",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "type": "com.google.appinventor.components.runtime.VerticalArrangement",
  ...
  "helpUrl": "<p>A formatting element in which to place components that should be displayed one below another.  (The first child component is stored on top, the second beneath it, etc.)  If you wish to have components displayed next to one another, use <code>HorizontalArrangement<\/code> instead.<\/p>",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "AlignHorizontal", "description": "A number that encodes how contents of the VerticalArrangement are aligned  horizontally. The choices are: 1 = left aligned, 2 = right aligned,  3 = horizontally centered.  Alignment has no effect if the arrangement's width is automatic.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Row", "description": "Row property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "Visible", "description": "Returns true iff the VerticalArrangement is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.VerticalScrollArrangement",
  ...
  "helpUrl": "<p>A formatting element in which to place components that should be displayed one below another.  (The first child component is stored on top, the second beneath it, etc.)  If you wish to have components displayed next to one another, use <code>HorizontalArrangement<\/code> instead.<\/p><p> This version is scrollable",
  "showOnPalette": "true",
  "nonVisible": "false",
  "iconName": "",
  "androidMinSdk": 7,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "AlignHorizontal", "description": "A number that encodes how contents of the VerticalScrollArrangement are aligned  horizontally. The choices are: 1 = left aligned, 2 = right aligned,  3 = horizontally centered.  Alignment has no effect if the arrangement's width is automatic.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Row", "description": "Row property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "Visible", "description": "Returns true iff the VerticalScrollArrangement is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "name": "Volume", "editorType": "non_negative_float", "defaultValue": "50", "editorArgs": []}],
  "blockProperties": [{ "name": "Column", "description": "Column property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the VideoPlayer is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.Web",
  ...
  "helpUrl": "Non-visible component that provides functions for HTTP GET, POST, PUT, and DELETE requests.",
  "showOnPalette": "true",
  "nonVisible": "true",
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True", "editorArgs": []}],
  "blockProperties": [{ "name": "Column", "description": "Column property getter method.", "type": "number", "rw": "invisible", "deprecated": "false"},
    ...
    { "name": "Height", "description": "Specifies the vertical height of the WebViewer, measured in pixels.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Visible", "description": "Returns true iff the WebViewer is visible.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
...
{ "type": "com.google.appinventor.components.runtime.YandexTranslate",
  ...
  "helpUrl": "Use this component to translate words and sentences between different languages. This component needs Internet access, as it will request translations to the Yandex.Translate service. Specify the source and target language in the form source-target using two letter language codes. So\"en-es\" will translate from English to Spanish while \"es-ru\" will translate from Spanish to Russian. If you leave out the source language, the service will attempt to detect the source language. So providing just \"es\" will attempt to detect the source language and translate it to Spanish.<p \/> This component is powered by the Yandex translation service.  See http:\/\/api.yandex.com\/translate\/ for more information, including the list of available languages and the meanings of the language codes and status codes. <p \/>Note: Translation happens asynchronously in the background. When the translation is complete, the \"GotTranslation\" event is triggered.",
  "showOnPalette": "true",
  "nonVisible": "true",
