...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True"}],
  "blockProperties": [{ "name": "BackgroundColor", "description": "The color of the canvas background.", "type": "number", "rw": "read-write", "deprecated": "false"},
    ...
    { "name": "Row", "description": "", "type": "number", "rw": "invisible", "deprecated": "false"},
    { "name": "TextAlignment", "description": "Determines the alignment of the text drawn by DrawText() or DrawAngle() with respect to the point specified by that command.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "Visible", "description": "Specifies whether the component should be visible on the screen. Value is true if the component is showing and false if hidden.", "type": "boolean", "rw": "read-write", "deprecated": "false"},
    { "name": "Width", "description": "", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "WidthPercent", "description": "", "type": "number", "rw": "write-only", "deprecated": "false"}],
...
{ "name": "FirebaseURL", "editorType": "FirbaseURL", "defaultValue": "DEFAULT"},
...
,
{ "type": "com.google.appinventor.components.runtime.GamePad",
  "name": "GamePad",
  "external": "false",
  "version": "1",
  "categoryString": "EXTENSION",
  "helpString": "A component that allows Gamepad Controller support for your app",
  "showOnPalette": "true",
  "nonVisible": "true",
  "iconName": "images/extension.png",
  "properties": [],
  "blockProperties": [{ "name": "AButton", "description": "Is the A button pressed?", "type": "boolean", "rw": "read-only", "deprecated": "false"},
    { "name": "BButton", "description": "Is the B button pressed?", "type": "boolean", "rw": "read-only", "deprecated": "false"},
    { "name": "DpadDown", "description": "Is the DPAD pressed down?", "type": "boolean", "rw": "read-only", "deprecated": "false"},
    { "name": "DpadLeft", "description": "Is the DPAD pressed left?", "type": "boolean", "rw": "read-only", "deprecated": "false"},
    { "name": "DpadRight", "description": "Is the DPAD pressed right?", "type": "boolean", "rw": "read-only", "deprecated": "false"},
    { "name": "DpadUp", "description": "Is the DPAD pressed up?", "type": "boolean", "rw": "read-only", "deprecated": "false"},
    { "name": "LeftBumper", "description": "Is the Left bumper pressed?", "type": "boolean", "rw": "read-only", "deprecated": "false"},
    { "name": "LeftJoystickX", "description": "The Left Joystick X value", "type": "number", "rw": "read-only", "deprecated": "false"},
    { "name": "LeftJoystickY", "description": "The Left Joystick Y value", "type": "number", "rw": "read-only", "deprecated": "false"},
    { "name": "LeftTrigger", "description": "The Left Trigger value", "type": "number", "rw": "read-only", "deprecated": "false"},
    { "name": "RightBumper", "description": "Is the Right bumper pressed?", "type": "boolean", "rw": "read-only", "deprecated": "false"},
    { "name": "RightJoystickX", "description": "The Right Joystick X value", "type": "number", "rw": "read-only", "deprecated": "false"},
    { "name": "RightJoystickY", "description": "The Right Joystick Y value", "type": "number", "rw": "read-only", "deprecated": "false"},
    { "name": "RightTrigger", "description": "The Right Trigger value", "type": "number", "rw": "read-only", "deprecated": "false"},
    { "name": "Select", "description": "Is the Select button pressed?", "type": "boolean", "rw": "read-only", "deprecated": "false"},
    { "name": "Start", "description": "Is the Start button pressed?", "type": "boolean", "rw": "read-only", "deprecated": "false"},
    { "name": "XButton", "description": "Is the X button pressed?", "type": "boolean", "rw": "read-only", "deprecated": "false"},
    { "name": "YButton", "description": "Is the Y button pressed?", "type": "boolean", "rw": "read-only", "deprecated": "false"}],
  "events": [],
  "methods": [{ "name": "DisableGamepad", "description": "This function disables the gamepad, leaving the EventDispatcher to deal with any key presses", "deprecated": "false", "params": []},
    { "name": "EnableGamepad", "description": "This function enables the gamepad, and must be called before keycodes can be grabbed.", "deprecated": "false", "params": []}]}
,
...
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True"}],
  "blockProperties": [{ "name": "AlignHorizontal", "description": "A number that encodes how contents of the arrangement are aligned  horizontally. The choices are: 1 = left aligned, 2 = right aligned,  3 = horizontally centered.  Alignment has no effect if the arrangement's width is automatic.", "type": "number", "rw": "read-write", "deprecated": "false"},
    { "name": "AlignVertical", "description": "A number that encodes how the contents of the arrangement are aligned  vertically. The choices are: 1 = aligned at the top, 2 = aligned at the bottom, 3 = vertically centered.  Alignment has no effect if the arrangement's height is automatic.", "type": "number", "rw": "read-write", "deprecated": "false"},
...
{ "name": "TextSize", "editorType": "non_negative_integer", "defaultValue": "22"},
{ "name": "Visible", "editorType": "visibility", "defaultValue": "True"}],
...
{ "type": "com.google.appinventor.components.runtime.Spinner",
  ...
  "properties": [{ "name": "ElementsFromString", "editorType": "string", "defaultValue": ""},
