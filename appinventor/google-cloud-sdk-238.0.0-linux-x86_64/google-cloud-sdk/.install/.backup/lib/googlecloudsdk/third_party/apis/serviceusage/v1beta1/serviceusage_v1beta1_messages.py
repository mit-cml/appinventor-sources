"""Generated message classes for serviceusage version v1beta1.
...
class BatchEnableServicesRequest(_messages.Message):
  ...
  Fields:
    serviceIds: The identifiers of the services to enable on the project.  A
      valid identifier would be: serviceusage.googleapis.com  Enabling
      services requires that each service is public or is shared with the user
      enabling the service.  Two or more services must be specified. To enable
      a single service, use the `EnableService` method instead.  A single
...
class Service(_messages.Message):
  ...
  config = _messages.MessageField('ServiceConfig', 1)
  name = _messages.StringField(2)
  parent = _messages.StringField(3)
  state = _messages.EnumField('StateValueValuesEnum', 4)
...
class ServiceusageServicesBatchEnableRequest(_messages.Message):
  r"""A ServiceusageServicesBatchEnableRequest object.
...
class ServiceusageServicesDisableRequest(_messages.Message):
  r"""A ServiceusageServicesDisableRequest object.
...
class ServiceusageServicesEnableRequest(_messages.Message):
  r"""A ServiceusageServicesEnableRequest object.
