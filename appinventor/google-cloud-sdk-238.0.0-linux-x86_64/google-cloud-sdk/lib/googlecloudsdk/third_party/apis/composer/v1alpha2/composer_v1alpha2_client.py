...
class ComposerV1alpha2(base_api.BaseApiClient):
  ...
  _CLIENT_CLASS_NAME = u'ComposerV1alpha2'
  ...
  class ProjectsLocationsEnvironmentsService(base_api.BaseApiService):
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha2/projects/{projectsId}/locations/{locationsId}/environments',
        http_method=u'POST',
        method_id=u'composer.projects.locations.environments.create',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[],
        relative_path=u'v1alpha2/{+parent}/environments',
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha2/projects/{projectsId}/locations/{locationsId}/environments/{environmentsId}',
  ...
  class ProjectsLocationsImageVersionsService(base_api.BaseApiService):
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v1alpha2/projects/{projectsId}/locations/{locationsId}/imageVersions',
        http_method=u'GET',
        method_id=u'composer.projects.locations.imageVersions.list',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[u'pageSize', u'pageToken'],
        relative_path=u'v1alpha2/{+parent}/imageVersions',
        request_field='',
...
corresponding to `Code.CANCELLED`.
    ...
    Cancel.method_config = lambda: base_api.ApiMethodInfo(
        ...
        http_method=u'POST',
        method_id=u'composer.projects.locations.operations.cancel',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v1alpha2/{+name}:cancel',
        request_field=u'cancelOperationRequest',
        request_type_name=u'ComposerProjectsLocationsOperationsCancelRequest',
