"""Generated client library for cloudtasks version v2beta3."""
# NOTE: This file is autogenerated and should not be edited by hand.
from apitools.base.py import base_api
from googlecloudsdk.third_party.apis.cloudtasks.v2beta3 import cloudtasks_v2beta3_messages as messages


class CloudtasksV2beta3(base_api.BaseApiClient):
  """Generated client library for service cloudtasks version v2beta3."""
  ...
  _CLIENT_CLASS_NAME = u'CloudtasksV2beta3'
  _URL_VERSION = u'v2beta3'
  _API_KEY = None
  ...
  def __init__(self, url='', credentials=None,
    ...
    super(CloudtasksV2beta3, self).__init__(
...
* For App Engine queues, the maximum task size is
  100KB.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks',
        http_method=u'POST',
        method_id=u'cloudtasks.projects.locations.queues.tasks.create',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[],
        relative_path=u'v2beta3/{+parent}/tasks',
...
failed.
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks/{tasksId}',
        http_method=u'DELETE',
        method_id=u'cloudtasks.projects.locations.queues.tasks.delete',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v2beta3/{+name}',
        request_field='',
...
task that has already succeeded or permanently failed.
    ...
    Run.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}/tasks/{tasksId}:run',
        http_method=u'POST',
        method_id=u'cloudtasks.projects.locations.queues.tasks.run',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v2beta3/{+name}:run',
  ...
  class ProjectsLocationsQueuesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudtasksV2beta3.ProjectsLocationsQueuesService, self).__init__(client)
      self._upload_configs = {
          }
...
before using this method.
    ...
    Create.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}/queues',
        http_method=u'POST',
        method_id=u'cloudtasks.projects.locations.queues.create',
        ordered_params=[u'parent'],
        path_params=[u'parent'],
        query_params=[],
        relative_path=u'v2beta3/{+parent}/queues',
...
before using this method.
    ...
    Delete.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}',
        http_method=u'DELETE',
...
* `cloudtasks.queues.getIamPolicy`
    ...
    GetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:getIamPolicy',
        http_method=u'POST',
        method_id=u'cloudtasks.projects.locations.queues.getIamPolicy',
        ordered_params=[u'resource'],
        path_params=[u'resource'],
        query_params=[],
        relative_path=u'v2beta3/{+resource}:getIamPolicy',
...
state is PAUSED.
    ...
    Pause.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:pause',
        http_method=u'POST',
        method_id=u'cloudtasks.projects.locations.queues.pause',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v2beta3/{+name}:pause',
...
might be dispatched before the purge takes effect. A purge is irreversible.
    ...
    Purge.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:purge',
        http_method=u'POST',
        method_id=u'cloudtasks.projects.locations.queues.purge',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v2beta3/{+name}:purge',
...
[Managing Cloud Tasks Scaling Risks](https://cloud.google.com/tasks/docs/manage-cloud-task-scaling).
    ...
    Resume.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:resume',
        http_method=u'POST',
        method_id=u'cloudtasks.projects.locations.queues.resume',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[],
        relative_path=u'v2beta3/{+name}:resume',
...
* `cloudtasks.queues.setIamPolicy`
    ...
    SetIamPolicy.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:setIamPolicy',
        http_method=u'POST',
        method_id=u'cloudtasks.projects.locations.queues.setIamPolicy',
        ordered_params=[u'resource'],
        path_params=[u'resource'],
        query_params=[],
        relative_path=u'v2beta3/{+resource}:setIamPolicy',
...
may "fail open" without warning.
    ...
    TestIamPermissions.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}/queues/{queuesId}:testIamPermissions',
        http_method=u'POST',
        method_id=u'cloudtasks.projects.locations.queues.testIamPermissions',
        ordered_params=[u'resource'],
        path_params=[u'resource'],
        query_params=[],
        relative_path=u'v2beta3/{+resource}:testIamPermissions',
  ...
  class ProjectsLocationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudtasksV2beta3.ProjectsLocationsService, self).__init__(client)
      self._upload_configs = {
          }
    ...
    Get.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations/{locationsId}',
        http_method=u'GET',
    ...
    List.method_config = lambda: base_api.ApiMethodInfo(
        flat_path=u'v2beta3/projects/{projectsId}/locations',
        http_method=u'GET',
        method_id=u'cloudtasks.projects.locations.list',
        ordered_params=[u'name'],
        path_params=[u'name'],
        query_params=[u'filter', u'pageSize', u'pageToken'],
        relative_path=u'v2beta3/{+name}/locations',
        request_field='',
  ...
  class ProjectsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      super(CloudtasksV2beta3.ProjectsService, self).__init__(client)
      self._upload_configs = {
          }
