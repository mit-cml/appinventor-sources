...
class Collections(enum.Enum):
  ...
  PROJECTS_LOCATIONS_DATASETS_FHIRSTORES_RESOURCES = (
      'projects.locations.datasets.fhirStores.resources',
      '{+name}',
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/datasets/'
              '{datasetsId}/fhirStores/{fhirStoresId}/resources/'
              '{resourcesId}/{resourcesId1}',
      },
      [u'name'],
      True
  )
  PROJECTS_LOCATIONS_DATASETS_FHIRSTORES_RESOURCES__HISTORY = (
      ...
      '{+name}',
      {
          '':
              'projects/{projectsId}/locations/{locationsId}/datasets/'
              '{datasetsId}/fhirStores/{fhirStoresId}/resources/'
              '{resourcesId}/{resourcesId1}/_history/{_historyId}',
      },
      [u'name'],
      True
  )
