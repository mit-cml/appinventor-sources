...
# The name of an environment variable specifying the default namespace
# to use for various services including memcache and datastore.
_ENV_DEFAULT_NAMESPACE = 'HTTP_X_APPENGINE_DEFAULT_NAMESPACE'
_ENV_CURRENT_NAMESPACE = 'HTTP_X_APPENGINE_CURRENT_NAMESPACE'

# Namespace string valid pattern matcher. Any sequence of
# the characters 0-9, A-Z, a-z, '.', '_' or '-'.
# Note: Keep this consistent with the java NamespaceManager
# constant of the same name and in appid_namespace.
#
