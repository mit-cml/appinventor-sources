"""Generated message classes for file version v1p1alpha1.
...
class FileProjectsLocationsSnapshotsGetRequest(_messages.Message):
...
class FileProjectsLocationsSnapshotsListRequest(_messages.Message):
  r"""A FileProjectsLocationsSnapshotsListRequest object.
...
class Snapshot(_messages.Message):
  ...
  Fields:
    ...
    sourceFileShare: Name of the file share in the source Cloud Filestore
      instance that the snapshot is created from.
    sourceInstance: Output only. The resource name of the source Cloud
