...
from googlecloudsdk.third_party.apis.file.v1p1alpha1 import file_v1p1alpha1_messages as messages
...
is the parent resource, without the operations collection id.
  ...
  class ProjectsLocationsSnapshotsService(base_api.BaseApiService):
    ...
    def List(self, request, global_params=None):
      r"""Lists all snapshots in a project for either a specified location.
or for all locations.
