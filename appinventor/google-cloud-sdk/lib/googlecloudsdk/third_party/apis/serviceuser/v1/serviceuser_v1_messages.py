"""Generated message classes for serviceuser version v1.
...
class PublishedService(_messages.Message):
  ...
  Fields:
    name: The resource name of the service.  A valid name would be: -
...
class SearchServicesResponse(_messages.Message):
  ...
  Fields:
    ...
    services: Services available publicly or available to the authenticated
      caller.
  """
...
class ServiceuserProjectsServicesListRequest(_messages.Message):
  ...
  Fields:
    ...
    pageToken: Token identifying which result to start with; returned by a
      previous list call.
    projectsId: Part of `parent`. List enabled services for the specified
