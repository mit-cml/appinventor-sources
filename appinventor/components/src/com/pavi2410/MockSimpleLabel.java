...
/**
 * Mock Simple Label component.
 *
 */
public final class MockSimpleLabel extends MockVisibleComponent {
  ...
  /**
   * Creates a new MockSimpleLabel component.
   *
   * @param editor  editor of source file the component belongs to
   */
  public MockSimpleLabel(SimpleEditor editor) {
