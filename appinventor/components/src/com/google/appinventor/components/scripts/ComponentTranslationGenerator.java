...
public final class ComponentTranslationGenerator extends ComponentProcessor {
  ...
  protected void outputResults() throws IOException {
    ...
    sb.append("  public static Map<String, Map<String, String>> extensionMap = new HashMap<String, Map<String, String>>();\n\n");
    sb.append("  private static String getName(String key) {\n");
    sb.append("    String value = myMap.get(key);\n");
    sb.append("    return key == null ? \"**Missing key in ComponentsTranslations**\" : value;\n");
    sb.append("  }\n");
    sb.append("\n");
    sb.append("  private static String getExtensionName(String componentType, String key) {\n");
    sb.append("    Map<String, String> map = extensionMap.get(componentType);\n");
    sb.append("    if (map == null) {\n");
    sb.append("      return null;\n");
    sb.append("    }\n");
    sb.append("    String value = map.get(key);\n");
    sb.append("    return key == null ? \"**Missing key in ComponentsTranslations**\" : value;\n");
    sb.append("  }\n");
    sb.append("\n");
    sb.append("  public static String getPropertyName(String componentType, String key) {\n");
    sb.append("    String value = getExtensionName(componentType, \"PROPERTY-\" + key);\n");
    sb.append("    if(value != null) return value;\n");
    sb.append("    value = getName(\"PROPERTY-\" + key);\n");
    sb.append("    return value == null ? key : value;\n");
    sb.append("  }\n");
    sb.append("\n");
    sb.append("  public static String getComponentName(String key) {\n");
    sb.append("    String value = getExtensionName(key, \"COMPONENT-\" + key);\n");
    sb.append("    if(value != null) return value;\n");
    sb.append("    value = getName(\"COMPONENT-\" + key);\n");
    sb.append("    return value == null ? key : value;\n");
    sb.append("  }\n");
    sb.append("\n");
    ...
    sb.append("    String value = getExtensionName(key, key + \"-helpString\");\n");
    sb.append("    if(value != null) return value;\n");
    sb.append("    value = getName(key + \"-helpString\");\n");
    sb.append("    return value == null ? key : value;\n");
    sb.append("  }\n");
