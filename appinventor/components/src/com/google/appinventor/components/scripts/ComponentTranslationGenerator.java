...
public final class ComponentTranslationGenerator extends ComponentProcessor {
  ...
  protected void outputResults() throws IOException {
    ...
    sb.append("  }\n");
    sb.append("\n");
    sb.append("  private static String getExtensionName(String componentName, String key) {\n");
    sb.append("    Map<String, String> map = extensionMap.get(componentName);\n");
    ...
    sb.append("  }\n");
    sb.append("\n");
    sb.append("  public static String getExtensionPropertyName(String componentName, String key) {\n");
    sb.append("    String value = getExtensionName(componentName, \"PROPERTY-\" + key);\n");
    sb.append("    if(value == null) return key;\n");
    sb.append("    return value;\n");
    sb.append("  }\n");
    sb.append("\n");
    sb.append("  public static String getExtensionComponentName(String componentName, String key) {\n");
    sb.append("    String value = getExtensionName(componentName, \"COMPONENT-\" + key);\n");
    sb.append("    if(value == null) return key;\n");
    sb.append("    return value;\n");
    sb.append("  }\n");
    sb.append("\n");
