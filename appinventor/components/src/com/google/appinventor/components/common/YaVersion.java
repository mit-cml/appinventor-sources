...
public class YaVersion {
  ...
  // - The HashTextEncode, HashFileEncode, HmacTextEncode, HmacFileEncode methods were added.
  // - The KeyReady event was added.
  // - The PrepareAesKey, AesFileEncrypt, AesTextEncrypt, AesFileDecrypt, AesTextDecrypt methods were added.
  // - The PrepareRsaKeyPair, RsaTextEncrypt, RsaTextDecrypt methods were added.
  // - The PrepareDsaKeyPair, DsaFileSign, DsaFileVerify methods were added.
