...
public class PlaneRenderer {
     ...
     * a {@link ARViewRender} callback, typically in {@link
     */
    public PlaneRenderer(ARViewRender render) throws IOException {
        Texture texture =
    ...
    public void drawPlanes(
            ARViewRender render, Collection<Plane> allPlanes, Pose cameraPose, float[] cameraProjection) {
