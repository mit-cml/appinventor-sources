...
@DesignerComponent(version = YaVersion.VERTICALRADIOGROUP_COMPONENT_VERSION,
...
@SimpleObject
public class VerticalRadioGroup extends RadioGroup {
  public VerticalRadioGroup(ComponentContainer container) {
