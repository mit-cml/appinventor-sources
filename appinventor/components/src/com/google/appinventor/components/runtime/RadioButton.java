 ...
 */
@DesignerComponent(version = YaVersion.RADIOBUTTON_COMPONENT_VERSION,
    description = "RadioButton that raises an event when the user clicks on it. " +
    "There are many properties affecting its appearance that can be set in " +
    "the Designer or Blocks Editor.",
    iconName = "images/radiobutton.png",
