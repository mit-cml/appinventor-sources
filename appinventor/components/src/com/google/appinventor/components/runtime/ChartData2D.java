...
public final class ChartData2D extends ChartDataBase {
     ...
     */
    public List ComputeLineOfBestFit(final YailList xEntries, final YailList yEntries) {
    ...
    public double GetLineOfBestFitSlope(final YailList x, final YailList y) {
        return (Double) ComputeLineOfBestFit(x, y).get(0);
    }
    ...
    public double GetLineOfBestFitYIntercept(final YailList x, final YailList y) {
        return (Double) ComputeLineOfBestFit(x, y).get(1);
    }
    ...
    public double GetLineOfBestFitCorrelationCoefficient(final YailList x, final YailList y) {
        return (Double) ComputeLineOfBestFit(x, y).get(2);
    }
    ...
    public void DrawLineOfBestFit(final YailList x, final YailList y) {
        List predictions = (List) ComputeLineOfBestFit(x, y).get(3);
