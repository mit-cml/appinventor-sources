...
/**
 * Utility function to ensure that the Certificate Authorities that we
...
public class AppinvSslSocketFactory {

  private static boolean DEBUG = true;
  private static final String LOG_TAG = "AppinvSslSocketFactory";
  ...
  private AppinvSslSocketFactory() {
  }
  ...
  public static SSLSocketFactory getSocketFactory() {
    if (sslSocketFactory != null) {
      ...
      try {
        ...
        Log.e(LOG_TAG, "Could not setup SSL Trust Store", e);
        throw new YailRuntimeError("Could Not setup SSL Trust Store", e.getMessage());
      }
    }
  }
