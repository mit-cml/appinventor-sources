...
public final class Look extends AndroidViewComponent implements Component {
    ...
    public static final int JSON_DECODING_ERROR = 1;
    ...
    private class JsObject {
        ...
        public void reportResult(final String result) {
            ...
            try {
                ...
                e.printStackTrace();
                ClassificationFailed(JSON_DECODING_ERROR, e.getMessage());
            }
        }
    }
}
