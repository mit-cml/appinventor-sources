...
class GpuBuffer {
    ...
    // These values refer to the byte count of the corresponding Java data types.
    ...
    public GpuBuffer(int target, int numberOfBytesPerEntry, Buffer entries) {
        if (entries != null) {
            ...
            // Some GPU drivers will fail without of memory errors if glBufferData or glBufferSubData is
