...
public class ListViewImageTwoTextVerticalAdapter extends ListAdapterWithRecyclerView {
  ...
  public ListViewImageTwoTextVerticalAdapter(
  ...
  public RvViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    return new ImageTwoTextVerticallyRvViewHolder(cardView, idCard, idFirst, idSecond, idImage);
  }

  @Override
  public void onBindViewHolder(RvViewHolder holder, int position) {
    ImageTwoTextVerticallyRvViewHolder imageTwoTextHolder = (ImageTwoTextVerticallyRvViewHolder) holder;
  ...
  public class ImageTwoTextVerticallyRvViewHolder extends RvViewHolder {
    public TextView textViewFirst;
    public TextView textViewSecond;
    public ImageView imageView;
    public CardView cardView;

    public ImageTwoTextVerticallyRvViewHolder(View view, int idCard, int idFirst, int idSecond, int idImage) {
      super(view);
