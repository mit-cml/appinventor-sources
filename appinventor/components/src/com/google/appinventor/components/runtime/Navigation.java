...
public class Navigation extends AndroidNonvisibleComponent implements Component {
  ...
  public static final String OPEN_ROUTE_SERVICE_URL = "https://api.openrouteservice.org/v2/%s/driving-car/geojson";
  ...
  //       out.write(coords.getBytes(StandardCharsets.UTF_8));
        
  //       final String directions = getResponseContent(connection);

  //       activity.runOnUiThread(new Runnable() {
  //         @Override
  //         public void run() {
  //           GotDirections(directions);
  //         }
  //       });
  //     } finally {
