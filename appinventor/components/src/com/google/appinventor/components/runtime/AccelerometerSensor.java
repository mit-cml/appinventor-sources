...
@DesignerComponent(version = YaVersion.ACCELEROMETERSENSOR_COMPONENT_VERSION,
    ...
    "     surface, positive when the phone is tilted to the left (i.e., " +
    "     its right side is raised), and negative when the phone is tilted " +
    "     to the right (i.e., its left size is raised).</li>\n " +
    "<li> <strong>yAccel</strong>: 0 when the phone is at rest on a flat " +
    "     surface, positive when its top is raised, and negative when " +
    "     its bottom is raised. </li>\n " +
