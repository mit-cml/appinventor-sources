 ...
 */
public class FileWriteOperation extends FileOperation<OutputStream> {
  ...
  public FileWriteOperation(Form form, Component component, String method, String fileName,
      FilePermissionMode permissionMode, boolean append, boolean async) {
    super(form, component, method, fileName, permissionMode,
  ...
  @Override
  OutputStream openFile() throws IOException {
    String path = FileUtil.resolveFileName(form, fileName, permissionMode);
