...
public class Web extends AndroidNonvisibleComponent implements Component {
   ...
   * Signals an error if the XML is not well-formed.   It can also produce unfamiliar results 
   * when the XML mixes terminal and non-terminal elements. For example,
   * <a><b>1 2 3</b>7777<c>4 5 6</c></a> decodes to ((a ((b 1 2 3) (c 4 5 6) (content 7777)))).
   *
   * @param jsonText the JSON text to decode
   * @return the decoded text
   */
  ...
  // string in a way that will look work both as a tooltip and in the autogenerated HTML for the
  // component documentation on the Web.
