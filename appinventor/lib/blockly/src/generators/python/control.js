...
Blockly.Python.controls_if = function() {
  ...
  var n = 0;
  var argument = Blockly.Python.valueToCode(this, n, true) || 'False';
  var branch = Blockly.Python.statementToCode(this, n) || '  pass\n';
  var code = 'if ' + argument + ':\n' + branch;
  for (n = 1; n <= this.elseifCount_; n++) {
    argument = Blockly.Python.valueToCode(this, n, true) || 'False';
    branch = Blockly.Python.statementToCode(this, n) || '  pass\n';
    code += 'elif ' + argument + ':\n' + branch;
  }
  if (this.elseCount_) {
    branch = Blockly.Python.statementToCode(this, n) || '  pass\n';
...
Blockly.Python.controls_whileUntil = function() {
  // Do while/until loop.
  var argument0 = Blockly.Python.valueToCode(this, 0, true) || 'False';
  var branch0 = Blockly.Python.statementToCode(this, 0) || '  pass\n';
