...
Blockly.Python.controls_if = function() {
  ...
  var n = 0;
  var argument = Blockly.Python.valueToCode(this, 'IF' + n, true) || 'False';
  var branch = Blockly.Python.statementToCode(this, 'DO' + n) || '  pass\n';
  var code = 'if ' + argument + ':\n' + branch;
  for (n = 1; n <= this.elseifCount_; n++) {
    argument = Blockly.Python.valueToCode(this, 'IF' + n, true) || 'False';
...
Blockly.Python.controls_for = function() {
  ...
  var argument0 = Blockly.Python.valueToCode(this, 'FROM', true) || '0';
  // If starting index is 0, omit it.
  argument0 = (parseInt(argument0, 10) === 0) ? '' : argument0 + ', ';
  var argument1 = Blockly.Python.valueToCode(this, 'TO', true) || '0';
